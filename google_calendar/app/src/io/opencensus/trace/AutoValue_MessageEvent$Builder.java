...
//            AutoValue_MessageEvent, MessageEvent
...
public final class  extends 
{
    ...
    public final MessageEvent build()
    {
        ...
        {
            return new AutoValue_MessageEvent(type, messageId.longValue(), uncompressedMessageSize.longValue(), compressedMessageSize.longValue());
        }
    }
