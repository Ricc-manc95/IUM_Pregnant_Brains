...
public final class CipherSuite extends Enum
{
    ...
    private static final CipherSuite TLS_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA;
    private static final CipherSuite TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA;
    private static final CipherSuite TLS_DHE_DSS_WITH_AES_128_CBC_SHA;
    private static final CipherSuite TLS_DHE_DSS_WITH_AES_128_CBC_SHA256;
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_128_GCM_SHA256;
    private static final CipherSuite TLS_DHE_DSS_WITH_AES_256_CBC_SHA;
    private static final CipherSuite TLS_DHE_DSS_WITH_AES_256_CBC_SHA256;
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_256_GCM_SHA384;
    private static final CipherSuite TLS_DHE_DSS_WITH_DES_CBC_SHA;
    private static final CipherSuite TLS_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA;
    private static final CipherSuite TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA;
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_128_CBC_SHA;
    private static final CipherSuite TLS_DHE_RSA_WITH_AES_128_CBC_SHA256;
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_128_GCM_SHA256;
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_256_CBC_SHA;
    private static final CipherSuite TLS_DHE_RSA_WITH_AES_256_CBC_SHA256;
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_256_GCM_SHA384;
    private static final CipherSuite TLS_DHE_RSA_WITH_DES_CBC_SHA;
    private static final CipherSuite TLS_DH_anon_EXPORT_WITH_DES40_CBC_SHA;
    private static final CipherSuite TLS_DH_anon_EXPORT_WITH_RC4_40_MD5;
    private static final CipherSuite TLS_DH_anon_WITH_3DES_EDE_CBC_SHA;
    private static final CipherSuite TLS_DH_anon_WITH_AES_128_CBC_SHA;
    private static final CipherSuite TLS_DH_anon_WITH_AES_128_CBC_SHA256;
    private static final CipherSuite TLS_DH_anon_WITH_AES_128_GCM_SHA256;
    private static final CipherSuite TLS_DH_anon_WITH_AES_256_CBC_SHA;
    private static final CipherSuite TLS_DH_anon_WITH_AES_256_CBC_SHA256;
    private static final CipherSuite TLS_DH_anon_WITH_AES_256_GCM_SHA384;
    private static final CipherSuite TLS_DH_anon_WITH_DES_CBC_SHA;
    private static final CipherSuite TLS_DH_anon_WITH_RC4_128_MD5;
    private static final CipherSuite TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA;
    public static final CipherSuite TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA;
    private static final CipherSuite TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256;
    public static final CipherSuite TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256;
    public static final CipherSuite TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA;
    private static final CipherSuite TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384;
    public static final CipherSuite TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384;
    private static final CipherSuite TLS_ECDHE_ECDSA_WITH_NULL_SHA;
    private static final CipherSuite TLS_ECDHE_ECDSA_WITH_RC4_128_SHA;
    private static final CipherSuite TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA;
    public static final CipherSuite TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA;
    private static final CipherSuite TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256;
    public static final CipherSuite TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256;
    public static final CipherSuite TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA;
    private static final CipherSuite TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384;
    public static final CipherSuite TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384;
    private static final CipherSuite TLS_ECDHE_RSA_WITH_NULL_SHA;
    private static final CipherSuite TLS_ECDHE_RSA_WITH_RC4_128_SHA;
    private static final CipherSuite TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA;
    private static final CipherSuite TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA;
    private static final CipherSuite TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256;
    private static final CipherSuite TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256;
    private static final CipherSuite TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA;
    private static final CipherSuite TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384;
    private static final CipherSuite TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384;
    private static final CipherSuite TLS_ECDH_ECDSA_WITH_NULL_SHA;
    private static final CipherSuite TLS_ECDH_ECDSA_WITH_RC4_128_SHA;
    private static final CipherSuite TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA;
    private static final CipherSuite TLS_ECDH_RSA_WITH_AES_128_CBC_SHA;
    private static final CipherSuite TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256;
    private static final CipherSuite TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256;
    private static final CipherSuite TLS_ECDH_RSA_WITH_AES_256_CBC_SHA;
    private static final CipherSuite TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384;
    private static final CipherSuite TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384;
    private static final CipherSuite TLS_ECDH_RSA_WITH_NULL_SHA;
    private static final CipherSuite TLS_ECDH_RSA_WITH_RC4_128_SHA;
    private static final CipherSuite TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA;
    private static final CipherSuite TLS_ECDH_anon_WITH_AES_128_CBC_SHA;
    private static final CipherSuite TLS_ECDH_anon_WITH_AES_256_CBC_SHA;
    private static final CipherSuite TLS_ECDH_anon_WITH_NULL_SHA;
    private static final CipherSuite TLS_ECDH_anon_WITH_RC4_128_SHA;
    private static final CipherSuite TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
    private static final CipherSuite TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5;
    private static final CipherSuite TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA;
    private static final CipherSuite TLS_KRB5_EXPORT_WITH_RC4_40_MD5;
    private static final CipherSuite TLS_KRB5_EXPORT_WITH_RC4_40_SHA;
    private static final CipherSuite TLS_KRB5_WITH_3DES_EDE_CBC_MD5;
    private static final CipherSuite TLS_KRB5_WITH_3DES_EDE_CBC_SHA;
    private static final CipherSuite TLS_KRB5_WITH_DES_CBC_MD5;
    private static final CipherSuite TLS_KRB5_WITH_DES_CBC_SHA;
    private static final CipherSuite TLS_KRB5_WITH_RC4_128_MD5;
    private static final CipherSuite TLS_KRB5_WITH_RC4_128_SHA;
    private static final CipherSuite TLS_RSA_EXPORT_WITH_DES40_CBC_SHA;
    private static final CipherSuite TLS_RSA_EXPORT_WITH_RC4_40_MD5;
    public static final CipherSuite TLS_RSA_WITH_3DES_EDE_CBC_SHA;
    public static final CipherSuite TLS_RSA_WITH_AES_128_CBC_SHA;
    private static final CipherSuite TLS_RSA_WITH_AES_128_CBC_SHA256;
    public static final CipherSuite TLS_RSA_WITH_AES_128_GCM_SHA256;
    public static final CipherSuite TLS_RSA_WITH_AES_256_CBC_SHA;
    private static final CipherSuite TLS_RSA_WITH_AES_256_CBC_SHA256;
    private static final CipherSuite TLS_RSA_WITH_AES_256_GCM_SHA384;
    private static final CipherSuite TLS_RSA_WITH_DES_CBC_SHA;
    private static final CipherSuite TLS_RSA_WITH_NULL_MD5;
    private static final CipherSuite TLS_RSA_WITH_NULL_SHA;
    private static final CipherSuite TLS_RSA_WITH_NULL_SHA256;
    private static final CipherSuite TLS_RSA_WITH_RC4_128_MD5;
    private static final CipherSuite TLS_RSA_WITH_RC4_128_SHA;
    public final String javaName;

    private CipherSuite(String s, int i, String s1)
    {
        super(s, i);
        javaName = s1;
    }
    ...
    public static CipherSuite forJavaName(String s)
    {
        ...
        {
            return (CipherSuite)Enum.valueOf(com/squareup/okhttp/CipherSuite, (new StringBuilder("TLS_")).append(s.substring(4)).toString());
        } else
        {
    ...
    static 
    {
        TLS_RSA_WITH_NULL_MD5 = new CipherSuite("TLS_RSA_WITH_NULL_MD5", 0, "SSL_RSA_WITH_NULL_MD5");
        TLS_RSA_WITH_NULL_SHA = new CipherSuite("TLS_RSA_WITH_NULL_SHA", 1, "SSL_RSA_WITH_NULL_SHA");
