...
final class arg._cls5
    implements android.content.MailPreferenceBinder..Lambda._cls4
{
    ...
    public final void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        com.google.android.calendar.api.settings.bda._cls4 _lcls4 = arg$3;
        ListPreference listpreference = arg$4;
        String as[] = arg$5;
        ((SmartMailPreferenceBinder) (dialoginterface)).viewModel.setMode(account, _lcls4, false);
        dialoginterface.updateVisibilityMode(listpreference, as, _lcls4);
    }

    (SmartMailPreferenceBinder smartmailpreferencebinder, Account account, com.google.android.calendar.api.settings.bda._cls4 _pcls4, ListPreference listpreference, String as[])
    {
