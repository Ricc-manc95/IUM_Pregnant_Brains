...
public final class CalendarAssistance extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        public final Builder setTaskAnnotationHint(String s)
        {
            copyOnWrite();
    ...
    public static final CalendarAssistance DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public String taskAnnotationHint_;
    public TaskAssistance taskAssistance_;

    private CalendarAssistance()
    {
        taskAnnotationHint_ = "";
    }

    public static CalendarAssistance parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\b\000\002\t\001", new Object[] {
            "bitField0_", "taskAnnotationHint_", "taskAssistance_"
        });
_L7:
...
_L9:
        com/google/android/calendar/task/CalendarAssistance;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new CalendarAssistance();
        CalendarAssistance calendarassistance = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/android/calendar/task/CalendarAssistance, calendarassistance);
    }
}
