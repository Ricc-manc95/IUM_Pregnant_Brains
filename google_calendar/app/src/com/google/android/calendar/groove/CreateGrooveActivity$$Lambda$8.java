    ...
    implements Runnable
{
    ...
    public final void run()
    {
        ...
        SnackbarFeedbackUtils.showSnackbarFeedback(creategrooveactivity, creategrooveactivity.getResources().getString(0x7f1300ba), true, null, 0);
        creategrooveactivity.finish();
        creategrooveactivity.logger.trackEvent(creategrooveactivity, creategrooveactivity.analyticsCategory, "goal_creation_offline");
    }
