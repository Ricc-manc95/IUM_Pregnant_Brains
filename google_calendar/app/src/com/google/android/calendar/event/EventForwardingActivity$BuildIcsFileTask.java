...
//            EventForwardingActivity, EventIcsBuilder

final class eventIcsBuilder extends AsyncTask
{
...
_L2:
        ...
        apair = android.provider.getContentResolver;
...
_L4:
    ...
    protected final void onPostExecute(Object obj)
    {
        ...
        if (uri != null)
        {
            ...
            obj1 = new android.content..getString(uri);
            ((Intent) (obj)).setClipData(new ClipData("iCalendar", new String[] {
                "text/calendar"
            }, ((android.content..getString) (obj1))));
