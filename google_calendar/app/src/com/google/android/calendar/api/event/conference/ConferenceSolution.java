...
public abstract class ConferenceSolution
    implements Parcelable
{
        ...
        implements Parcelable
    {
        ...
        public static Key create(String s)
        {
...
_L14:
        ...
        public static Key create(String s, AddOnId addonid)
        {
            if (s != null) goto _L2; else goto _L1
_L1:
            s = "unknownConferenceSolution";
...
_L14:
    ...
    public static abstract class Key.AddOnId
        implements Parcelable
    {
