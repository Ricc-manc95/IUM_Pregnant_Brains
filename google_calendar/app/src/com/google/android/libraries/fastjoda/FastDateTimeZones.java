...
public final class FastDateTimeZones
{
        ...
        implements Provider
    {
        ...
        public final DateTimeZone getZone(String s)
        {
            ...
            } else
            {
                ...
                if (datetimezone == null)
                {
                    ...
                    {
                        obj1 = new FastDateTimeZone(((TimeZone) (obj)));
                    }
        ...
        public FastDateTimeZoneProvider()
        {
        }

        private class FastDateTimeZone extends DateTimeZone
        {
...
label0:
            ...
            public final boolean equals(Object obj)
            {
                ...
                } else
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        {
                            obj = (FastDateTimeZone)obj;
                            return timeZone.equals(((FastDateTimeZone) (obj)).timeZone);
                        }
                    }
                }
                return flag;
            ...
            FastDateTimeZone(TimeZone timezone)
            {
