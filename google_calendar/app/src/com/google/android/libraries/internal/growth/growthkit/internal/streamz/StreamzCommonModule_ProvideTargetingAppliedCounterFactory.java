...
public final class StreamzCommonModule_ProvideTargetingAppliedCounterFactory
    implements Factory
{
    ...
    public StreamzCommonModule_ProvideTargetingAppliedCounterFactory()
    {
    }
    ...
    public final Object get()
    {
        ...
        obj = (Counter1)((MetricFactory) (obj)).getOrCreate(new Counter1("/client_streamz/android_growthkit/targeting_applied_count", ((com.google.android.libraries.streamz.MetricConfigProvider) (obj)), new Field("package_name", java/lang/String)));
        if (obj == null)
        {
