...
public final class GrowthKitProperties extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final GrowthKitProperties DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public long growthkitVersion_;

    private GrowthKitProperties()
    {
    }

    public static GrowthKitProperties parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (GrowthKitProperties)obj;
    }
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new GrowthKitProperties();
        GrowthKitProperties growthkitproperties = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/android/libraries/internal/growth/growthkit/internal/experiments/proto/GrowthKitProperties, growthkitproperties);
    }
}
