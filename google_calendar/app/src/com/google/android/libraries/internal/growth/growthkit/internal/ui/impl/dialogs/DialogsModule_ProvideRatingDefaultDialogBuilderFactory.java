...
public final class DialogsModule_ProvideRatingDefaultDialogBuilderFactory
    implements Factory
{

    public static final DialogsModule_ProvideRatingDefaultDialogBuilderFactory INSTANCE = new DialogsModule_ProvideRatingDefaultDialogBuilderFactory();

    public DialogsModule_ProvideRatingDefaultDialogBuilderFactory()
    {
    }
