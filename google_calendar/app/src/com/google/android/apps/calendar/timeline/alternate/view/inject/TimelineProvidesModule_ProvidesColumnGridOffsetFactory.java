...
public final class TimelineProvidesModule_ProvidesColumnGridOffsetFactory
    implements Factory
{

    private final TimelineProvidesModule module;

    public TimelineProvidesModule_ProvidesColumnGridOffsetFactory(TimelineProvidesModule timelineprovidesmodule)
    {
