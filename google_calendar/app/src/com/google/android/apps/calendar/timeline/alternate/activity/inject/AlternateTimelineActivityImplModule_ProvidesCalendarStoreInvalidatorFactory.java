...
public final class AlternateTimelineActivityImplModule_ProvidesCalendarStoreInvalidatorFactory
    implements Factory
{
    ...
    public AlternateTimelineActivityImplModule_ProvidesCalendarStoreInvalidatorFactory(Provider provider, Provider provider1)
    {
    ...
    public final Object get()
    {
        ...
        obj = AlternateTimelineActivityImplModule.providesCalendarStoreInvalidator(((Boolean)((Provider) (obj)).get()).booleanValue(), provider);
        if (obj == null)
        {
