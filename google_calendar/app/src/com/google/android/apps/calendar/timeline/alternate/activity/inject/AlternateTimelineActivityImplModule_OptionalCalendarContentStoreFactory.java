...
public final class AlternateTimelineActivityImplModule_OptionalCalendarContentStoreFactory
    implements Factory
{
    ...
    public AlternateTimelineActivityImplModule_OptionalCalendarContentStoreFactory(Provider provider, Provider provider1)
    {
    ...
    public final Object get()
    {
        ...
        obj = AlternateTimelineActivityImplModule.optionalCalendarContentStore(((Boolean)((Provider) (obj)).get()).booleanValue(), provider);
        if (obj == null)
        {
