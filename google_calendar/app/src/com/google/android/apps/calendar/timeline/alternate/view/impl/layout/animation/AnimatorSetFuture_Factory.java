...
public final class AnimatorSetFuture_Factory
    implements Factory
{

    private final Provider idleTrackerProvider;

    public AnimatorSetFuture_Factory(Provider provider)
    {
    ...
    {
        return new AnimatorSetFuture((IdleTracker)idleTrackerProvider.get());
    }
}
