...
public final class TimelineProvidesModule_ProvidesDragStateFactory
    implements Factory
{

    private final TimelineProvidesModule module;

    public TimelineProvidesModule_ProvidesDragStateFactory(TimelineProvidesModule timelineprovidesmodule)
    {
