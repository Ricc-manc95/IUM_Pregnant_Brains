...
// Referenced classes of package com.google.frameworks.client.streamz:
//            StreamzObjectsProto

public static final class inc_ extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final class Increment extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {
        ...
        public static Increment parseFrom(InputStream inputstream)
            throws IOException
        {
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new Increment();
            Increment increment = DEFAULT_INSTANCE;
    ...
    public static final class Increment.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {
    ...
    public static final class Increment.Field extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final Increment.Field DEFAULT_INSTANCE;
        private static volatile Parser PARSER;
        public int bitField0_;
        public int valueCase_;
        public Object value_;

        public static Increment.Field parseFrom(InputStream inputstream)
            throws IOException
        {
            Object obj = DEFAULT_INSTANCE;
            if (inputstream == null)
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new Increment.Field();
            Increment.Field field = DEFAULT_INSTANCE;
        ...
        private Increment.Field()
        {
            valueCase_ = 0;
        }
    }

    public static final class Increment.Field.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        Increment.Field.Builder()
        {
            super(Increment.Field.DEFAULT_INSTANCE);
        }
    }

    public static final class Increment.Value extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final Increment.Value DEFAULT_INSTANCE;
        private static volatile Parser PARSER;
        public int bitField0_;
        public int valueCase_;
        public Object value_;

        public static Increment.Value parseFrom(InputStream inputstream)
            throws IOException
        {
            Object obj = DEFAULT_INSTANCE;
            if (inputstream == null)
