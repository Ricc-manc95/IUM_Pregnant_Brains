...
{
    public static final class AncestryVisualElementProto extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {
        ...
        public com.google.protobuf.Internal.IntList pathToRootElementId_;
        public int userAction_;

        public static AncestryVisualElementProto parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (AncestryVisualElementProto)obj;
        }
...
_L5:
            obj = new AncestryVisualElementProto();
_L10:
            return obj;
_L6:
            return new Builder();
_L4:
            obj = com.google.common.logging.proto2api.UserActionEnum.UserAction.internalVerifier;
            com.google.protobuf.Internal.EnumVerifier enumverifier = com.google.common.logging.proto2api.UserActionEnum.CardinalDirection.internalVerifier;
            return new RawMessageInfo(DEFAULT_INSTANCE, "\001\005\000\001\001\007\005\000\001\000\001\004\000\002\004\001\003\026\004\f\002\007\f\003", new Object[] {
                "bitField0_", "elementId_", "elementIndex_", "pathToRootElementId_", "userAction_", obj, "cardinalDirection_", enumverifier
            });
_L7:
...
_L9:
            com/google/common/logging/AncestryVisualElement$AncestryVisualElementProto;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new AncestryVisualElementProto();
            AncestryVisualElementProto ancestryvisualelementproto = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(com/google/common/logging/AncestryVisualElement$AncestryVisualElementProto, ancestryvisualelementproto);
        }

        private AncestryVisualElementProto()
        {
            pathToRootElementId_ = IntArrayList.EMPTY_LIST;
        }
    }

    public static final class AncestryVisualElementProto.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        AncestryVisualElementProto.Builder()
        {
