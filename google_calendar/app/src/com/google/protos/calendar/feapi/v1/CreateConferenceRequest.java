...
//            NamedHangoutOptions, ConferenceRequestStatus

public final class CreateConferenceRequest extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final CreateConferenceRequest DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public ConferenceSolution.Key conferenceSolutionKey_;
    public NamedHangoutOptions namedHangoutOptions_;
    public String requestId_;
    public ConferenceRequestStatus status_;
    ...
    public static CreateConferenceRequest parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (CreateConferenceRequest)generatedmessagelite;
    }
...
_L5:
        obj = new CreateConferenceRequest();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\004\000\001\001\006\004\000\000\000\001\b\000\003\t\003\005\t\004\006\t\001", new Object[] {
            "bitField0_", "requestId_", "namedHangoutOptions_", "status_", "conferenceSolutionKey_"
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/CreateConferenceRequest;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new CreateConferenceRequest();
        CreateConferenceRequest createconferencerequest = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/CreateConferenceRequest, createconferencerequest);
    }
}
