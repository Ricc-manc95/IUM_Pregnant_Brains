...
public final class OutOfOffice extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(OutOfOffice.DEFAULT_INSTANCE);
        }
    }


    public static final OutOfOffice DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public AutoReply autoReply_;
    public int bitField0_;
    public String calendarDeclineMessage_;
    public boolean declineConflictingEvents_;

    private OutOfOffice()
    {
        calendarDeclineMessage_ = "";
    }

    public static OutOfOffice parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (OutOfOffice)generatedmessagelite;
    }
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\b\001\002\t\002\003\007\0", new Object[] {
            "bitField0_", "calendarDeclineMessage_", "autoReply_", "declineConflictingEvents_"
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/OutOfOffice;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new OutOfOffice();
        OutOfOffice outofoffice = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/OutOfOffice, outofoffice);
    }
}
