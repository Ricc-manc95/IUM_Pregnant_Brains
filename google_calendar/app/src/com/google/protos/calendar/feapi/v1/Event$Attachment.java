...
public static final class fileId_ extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(Event.Attachment.DEFAULT_INSTANCE);
        }
    }
        ...
        throws IOException
    {
        ...
        if (generatedmessagelite != null)
        {
            ...
            } else
            {
                ...
                if (flag1)
                {
                    int i = android.support.v4.content.tatus.SET_MEMOIZED_IS_INITIALIZED._fld9HHMUR9FCTNMUPRCCKNN0SJFEHNM4TB65T3MARJ5E9GN8PB49LIN6SR1CTIKOQBKCKI4QPBKD1NM8L3F95N7CRRBCKTG____0;
                    if (flag)
                    {
        ...
        return (Message)generatedmessagelite;
    }
...
_L11:
        obj = new com.google.protobuf.ite.DefaultInstanceBasedParser(DEFAULT_INSTANCE);
        PARSER = ((Parser) (obj));
_L12:
        com/google/protos/calendar/feapi/v1/Event$Attachment;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/Event$Attachment, parser);
    }
