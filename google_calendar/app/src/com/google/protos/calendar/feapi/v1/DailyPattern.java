...
public final class DailyPattern extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public boolean afternoon_;
    public boolean any_;
    public int bitField0_;
    public boolean evening_;
    public boolean morning_;

    private DailyPattern()
    {
    }

    public static DailyPattern parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (DailyPattern)generatedmessagelite;
    }
...
_L5:
        obj = new DailyPattern();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\004\000\001\001\004\004\000\000\000\001\007\000\002\007\001\003\007\002\004\007\003", new Object[] {
            "bitField0_", "any_", "morning_", "afternoon_", "evening_"
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/DailyPattern;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new DailyPattern();
        DailyPattern dailypattern = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/DailyPattern, dailypattern);
    }
}
