...
public final class ConferenceData extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(ConferenceData.DEFAULT_INSTANCE);
        }
    }


    public static final ConferenceData DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public String conferenceId_;
    public ConferenceSolution conferenceSolution_;
    public com.google.protobuf.Internal.ProtobufList conference_;
    public CreateConferenceRequest createRequest_;
    public String notes_;
    public ConferenceParameters parameters_;
    public String signature_;

    private ConferenceData()
    {
        conference_ = ProtobufArrayList.EMPTY_LIST;
        conferenceId_ = "";
        signature_ = "";
        notes_ = "";
    }

    public static ConferenceData parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (ConferenceData)generatedmessagelite;
    }
...
_L5:
        obj = new ConferenceData();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\007\000\001\001\013\007\000\001\000\001\033\003\t\000\007\t\003\b\b\005\t\t\001\n\b\004\013\b\006", new Object[] {
            "bitField0_", "conference_", com/google/protos/calendar/feapi/v1/Conference, "createRequest_", "parameters_", "signature_", "conferenceSolution_", "conferenceId_", "notes_"
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/ConferenceData;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new ConferenceData();
        ConferenceData conferencedata = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/ConferenceData, conferencedata);
    }
}
