...
public final class NamedHangoutOptions extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(NamedHangoutOptions.DEFAULT_INSTANCE);
        }
    }


    public static final NamedHangoutOptions DEFAULT_INSTANCE;
    private static volatile Parser PARSER;

    private NamedHangoutOptions()
    {
    }

    public static NamedHangoutOptions parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (NamedHangoutOptions)generatedmessagelite;
    }
...
_L9:
        com/google/protos/calendar/feapi/v1/NamedHangoutOptions;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new NamedHangoutOptions();
        NamedHangoutOptions namedhangoutoptions = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/NamedHangoutOptions, namedhangoutoptions);
    }
}
