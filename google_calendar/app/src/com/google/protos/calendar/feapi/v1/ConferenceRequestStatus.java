...
public final class ConferenceRequestStatus extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(ConferenceRequestStatus.DEFAULT_INSTANCE);
        }
    }
        ...
        implements com.google.protobuf.Internal.EnumLite
    {
        ...
        static 
        {
            ...
            PENDING = new StatusCode("PENDING", 1, 1);
            SUCCESS = new StatusCode("SUCCESS", 2, 2);
            FAILURE = new StatusCode("FAILURE", 3, 3);
    ...
    public static final ConferenceRequestStatus DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public int statusCode_;

    private ConferenceRequestStatus()
    {
    }

    public static ConferenceRequestStatus parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (ConferenceRequestStatus)generatedmessagelite;
    }
...
_L5:
        obj = new ConferenceRequestStatus();
_L10:
        return obj;
_L6:
        return new Builder();
...
_L9:
        com/google/protos/calendar/feapi/v1/ConferenceRequestStatus;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new ConferenceRequestStatus();
        ConferenceRequestStatus conferencerequeststatus = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/ConferenceRequestStatus, conferencerequeststatus);
    }
}
