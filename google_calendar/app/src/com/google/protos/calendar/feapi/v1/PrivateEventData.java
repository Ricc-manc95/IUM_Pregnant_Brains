...
public final class PrivateEventData extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(PrivateEventData.DEFAULT_INSTANCE);
        }
    }


    public static final PrivateEventData DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    private byte memoizedIsInitialized;
    public SmartMailInfo smartMailInfo_;
    ...
    public static PrivateEventData parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (PrivateEventData)generatedmessagelite;
    }
...
_L5:
        obj = new PrivateEventData();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\001\002\002\001\000\000\001\002\u0409\0", new Object[] {
            "bitField0_", "smartMailInfo_"
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/PrivateEventData;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new PrivateEventData();
        PrivateEventData privateeventdata = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/PrivateEventData, privateeventdata);
    }
}
