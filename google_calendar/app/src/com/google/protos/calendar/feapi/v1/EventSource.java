...
public final class EventSource extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(EventSource.DEFAULT_INSTANCE);
        }
    }


    public static final EventSource DEFAULT_INSTANCE;
    ...
    public static EventSource parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (EventSource)generatedmessagelite;
    }
...
_L9:
        com/google/protos/calendar/feapi/v1/EventSource;
...
_L3:
    ...
    static 
    {
        ...
        EventSource eventsource = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/EventSource, eventsource);
    }
}
