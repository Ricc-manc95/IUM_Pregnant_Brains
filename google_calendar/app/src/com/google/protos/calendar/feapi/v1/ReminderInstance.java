...
public final class ReminderInstance extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(ReminderInstance.DEFAULT_INSTANCE);
        }
    }
        ...
        implements com.google.protobuf.Internal.EnumLite
    {
        ...
        public static final Method POPUP;
        ...
        private Method(String s, int i, int j)
        {
            super(s, 0);
        }
    }
    ...
    public static final ReminderInstance DEFAULT_INSTANCE;
    ...
    public static ReminderInstance parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (ReminderInstance)generatedmessagelite;
    }
...
_L5:
        obj = new ReminderInstance();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        obj = Method.internalVerifier;
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\f\000\002\004\001", new Object[] {
            "bitField0_", "method_", obj, "minutes_"
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/ReminderInstance;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new ReminderInstance();
        ReminderInstance reminderinstance = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/ReminderInstance, reminderinstance);
    }
}
