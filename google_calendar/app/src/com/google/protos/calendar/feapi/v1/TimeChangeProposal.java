...
public final class TimeChangeProposal extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TimeChangeProposal.DEFAULT_INSTANCE);
        }
    }


    public static final TimeChangeProposal DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public long endTimeMillis_;
    public long startTimeMillis_;

    private TimeChangeProposal()
    {
    }

    public static TimeChangeProposal parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (TimeChangeProposal)generatedmessagelite;
    }
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\002\003\002\000\000\000\002\002\000\003\002\001", new Object[] {
...
_L9:
        com/google/protos/calendar/feapi/v1/TimeChangeProposal;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TimeChangeProposal();
        TimeChangeProposal timechangeproposal = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/TimeChangeProposal, timechangeproposal);
    }
}
