...
public final class ByDay extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final ByDay DEFAULT_INSTANCE;
    ...
    public static ByDay parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (ByDay)generatedmessagelite;
    }
...
_L6:
        return new Builder();
_L4:
        obj = Weekday.internalVerifier;
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\004\000\002\f\001", new Object[] {
            "bitField0_", "offset_", "weekday_", obj
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/ByDay;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new ByDay();
        ByDay byday = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/ByDay, byday);
    }
}
