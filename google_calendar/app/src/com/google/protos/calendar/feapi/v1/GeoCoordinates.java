...
public final class GeoCoordinates extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(GeoCoordinates.DEFAULT_INSTANCE);
        }
    }


    public static final GeoCoordinates DEFAULT_INSTANCE;
    ...
    public static GeoCoordinates parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (GeoCoordinates)generatedmessagelite;
    }
...
_L5:
        obj = new GeoCoordinates();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\000\000\002\000\001", new Object[] {
            "bitField0_", "latitude_", "longitude_"
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/GeoCoordinates;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new GeoCoordinates();
        GeoCoordinates geocoordinates = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/GeoCoordinates, geocoordinates);
    }
}
