...
public final class EventLocation extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(EventLocation.DEFAULT_INSTANCE);
        }
    }


    public static final EventLocation DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public Address address_;
    public int bitField0_;
    public GeoCoordinates geo_;
    public String mapsClusterId_;
    public String name_;
    public String placeId_;
    public boolean serverGeocoded_;
    public String url_;
    ...
    public static EventLocation parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (EventLocation)generatedmessagelite;
    }
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\007\000\001\001\007\007\000\000\000\001\b\000\002\b\002\003\t\003\004\t\004\005\b\005\006\007\006\007\b\001", new Object[] {
            "bitField0_", "mapsClusterId_", "name_", "address_", "geo_", "url_", "serverGeocoded_", "placeId_"
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/EventLocation;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new EventLocation();
        EventLocation eventlocation = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/EventLocation, eventlocation);
    }
}
