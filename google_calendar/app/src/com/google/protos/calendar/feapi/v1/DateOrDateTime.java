...
public final class DateOrDateTime extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(DateOrDateTime.DEFAULT_INSTANCE);
        }
    }


    public static final DateOrDateTime DEFAULT_INSTANCE;
    ...
    public static DateOrDateTime parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (DateOrDateTime)generatedmessagelite;
    }
...
_L5:
        obj = new DateOrDateTime();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\002\000\002\t\001\003\b\002", new Object[] {
            "bitField0_", "dateMs_", "dateTime_", "timeZone_"
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/DateOrDateTime;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new DateOrDateTime();
        DateOrDateTime dateordatetime = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/DateOrDateTime, dateordatetime);
    }
}
