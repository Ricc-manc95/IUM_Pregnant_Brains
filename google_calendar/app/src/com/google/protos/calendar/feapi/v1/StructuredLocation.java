...
public final class StructuredLocation extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(StructuredLocation.DEFAULT_INSTANCE);
        }
    }


    public static final StructuredLocation DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList location_;

    private StructuredLocation()
    {
        location_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static StructuredLocation parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (StructuredLocation)generatedmessagelite;
    }
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\000\001\001\001\000\001\000\001\033", new Object[] {
            "location_", com/google/protos/calendar/feapi/v1/EventLocation
        });
_L7:
...
_L9:
        com/google/protos/calendar/feapi/v1/StructuredLocation;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new StructuredLocation();
        StructuredLocation structuredlocation = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/StructuredLocation, structuredlocation);
    }
}
