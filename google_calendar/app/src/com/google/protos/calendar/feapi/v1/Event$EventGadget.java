...
public static final class preference_ extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(Event.EventGadget.DEFAULT_INSTANCE);
        }
    }

    public static final class Preference extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {
            ...
            throws IOException
        {
            ...
            return (Preference)generatedmessagelite;
        }
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new Preference();
            Preference preference = DEFAULT_INSTANCE;
    ...
    public static final class Preference.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {
    ...
    public static final ceMap DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public com.google.protobuf.ist preference_;

    public static Preference.Builder parseFrom(InputStream inputstream)
        throws IOException
    {
        GeneratedMessageLite generatedmessagelite = GeneratedMessageLite.parsePartialFrom(DEFAULT_INSTANCE, CodedInputStream.newInstance(inputstream), ExtensionRegistryLite.getEmptyRegistry());
        if (generatedmessagelite != null)
        ...
        return (essage)generatedmessagelite;
    }
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/protos/calendar/feapi/v1/Event$EventGadget, parser);
    }

    private Preference.value_()
    {
