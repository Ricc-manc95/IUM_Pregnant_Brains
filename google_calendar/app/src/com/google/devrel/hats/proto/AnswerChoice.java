...
public final class AnswerChoice extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static AnswerChoice parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new AnswerChoice();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\002\000\000\001\003\002\000\000\000\001\u0208\003\004", new Object[] {
            "choiceText_", "skipTo_"
        });
_L7:
...
_L9:
        com/google/devrel/hats/proto/AnswerChoice;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new AnswerChoice();
        AnswerChoice answerchoice = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/devrel/hats/proto/AnswerChoice, answerchoice);
    }
}
