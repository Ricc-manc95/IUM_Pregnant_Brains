...
public final class QuestionAnswer extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final QuestionAnswer DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int answerIndex_;
    public int choiceType_;
    public boolean forPiping_;
    public String predefinedAnswerText_;
    public float rating_;
    public String userAnswerText_;

    private QuestionAnswer()
    {
        predefinedAnswerText_ = "";
        userAnswerText_ = "";
    }
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\006\000\000\001\b\006\000\000\000\001\004\003\001\004\f\005\u0208\006\u0208\b\007", new Object[] {
            "answerIndex_", "rating_", "choiceType_", "predefinedAnswerText_", "userAnswerText_", "forPiping_"
        });
_L7:
...
_L9:
        com/google/devrel/hats/proto/QuestionAnswer;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new QuestionAnswer();
        QuestionAnswer questionanswer = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/devrel/hats/proto/QuestionAnswer, questionanswer);
    }
}
