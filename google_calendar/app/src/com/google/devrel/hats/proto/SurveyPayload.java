...
public final class SurveyPayload extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(SurveyPayload.DEFAULT_INSTANCE);
        }
    }


    public static final SurveyPayload DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public com.google.protobuf.Internal.ProtobufList question_;

    private SurveyPayload()
    {
        question_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static SurveyPayload parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new SurveyPayload();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\001\000\001\004\004\001\000\001\000\004\033", new Object[] {
            "bitField0_", "question_", com/google/devrel/hats/proto/Question
        });
_L7:
...
_L9:
        com/google/devrel/hats/proto/SurveyPayload;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new SurveyPayload();
        SurveyPayload surveypayload = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/devrel/hats/proto/SurveyPayload, surveypayload);
    }
}
