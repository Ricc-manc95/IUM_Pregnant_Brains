...
public final class QuestionRating extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(QuestionRating.DEFAULT_INSTANCE);
        }
    }


    public static final QuestionRating DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public com.google.protobuf.Internal.ProtobufList label_;
    public int numStars_;
    public com.google.protobuf.Internal.IntList skipTo_;

    private QuestionRating()
    {
        label_ = ProtobufArrayList.EMPTY_LIST;
        skipTo_ = IntArrayList.EMPTY_LIST;
    }

    public static QuestionRating parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new QuestionRating();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\003\000\001\001\003\003\000\002\000\001\004\002\u021A\003'", new Object[] {
            "bitField0_", "numStars_", "label_", "skipTo_"
        });
_L7:
...
_L9:
        com/google/devrel/hats/proto/QuestionRating;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new QuestionRating();
        QuestionRating questionrating = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/devrel/hats/proto/QuestionRating, questionrating);
    }
}
