...
public static final class clause_ extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(Promotion.ClientSideTargetingRule.DEFAULT_INSTANCE);
        }
    }

    public static final class TargetingClause extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {
        ...
        public static TargetingClause parseFrom(InputStream inputstream)
            throws IOException
        {
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new TargetingClause();
            TargetingClause targetingclause = DEFAULT_INSTANCE;
    ...
    public static final class TargetingClause.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        TargetingClause.Builder()
        {
            super(TargetingClause.DEFAULT_INSTANCE);
        }
    }

    public static final class TargetingTerm extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {
        ...
        public static TargetingTerm parseFrom(InputStream inputstream)
            throws IOException
        {
            Object obj = DEFAULT_INSTANCE;
            if (inputstream == null)
...
_L4:
            return new RawMessageInfo(DEFAULT_INSTANCE, "\001\004\001\001\001\004\004\000\000\000\001\007\000\002<\000\003<\000\004<\0", new Object[] {
                "predicate_", "predicateCase_", "bitField0_", "negate_", com/google/identity/growth/proto/Promotion$EventCountPredicate, com/google/identity/growth/proto/Promotion$AppStatePredicate, com/google/identity/growth/