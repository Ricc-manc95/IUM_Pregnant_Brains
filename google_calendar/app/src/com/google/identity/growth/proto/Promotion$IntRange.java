    ...
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(Promotion.IntRange.DEFAULT_INSTANCE);
        }
    }


    public static final anceMap DEFAULT_INSTANCE;
        ...
        throws IOException
    {
        ...
        {
            inputstream = new com.google.protobuf.reamDecoder(inputstream, 4096);
        }
        ...
        if (obj != null)
        {
            ...
            } else
            {
                ...
                if (flag1)
                {
                    int i = android.support.v4.content.tus.SET_MEMOIZED_IS_INITIALIZED._fld9HHMUR9FCTNMUPRCCKNN0SJFEHNM4TB65T3MARJ5E9GN8PB49LIN6SR1CTIKOQBKCKI4QPBKD1NM8L3F95N7CRRBCKTG____0;
                    if (flag)
                    {
...
_L11:
        obj = new com.google.protobuf.e.DefaultInstanceBasedParser(DEFAULT_INSTANCE);
        PARSER = ((Parser) (obj));
_L12:
        com/google/identity/growth/proto/Promotion$IntRange;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/identity/growth/proto/Promotion$IntRange, parser);
    }
