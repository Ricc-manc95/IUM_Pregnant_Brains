...
// Referenced classes of package com.google.identity.boq.growth.promoprovider.proto:
//            PromoProvider

public static final class eventToMonitor_ extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(PromoProvider.ClientMonitoring.DEFAULT_INSTANCE);
        }
    }

    public static final class MonitoredEvent extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {
        ...
        public static MonitoredEvent parseFrom(InputStream inputstream)
            throws IOException
        {
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new MonitoredEvent();
            MonitoredEvent monitoredevent = DEFAULT_INSTANCE;
    ...
    public static final class MonitoredEvent.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        MonitoredEvent.Builder()
        {
            super(MonitoredEvent.DEFAULT_INSTANCE);
        }
    }

    public static final class MonitoredEvent.EventCase extends Enum
        implements com.google.protobuf.Internal.EnumLite
    {

        private static final MonitoredEvent.EventCase $VALUES[];
        public static final MonitoredEvent.EventCase CLEARCUT_EVENT;
        private static final MonitoredEvent.EventCase EVENT_NOT_SET;
        public static final MonitoredEvent.EventCase VE_EVENT;
        private final int value;

        public static MonitoredEvent.EventCase forNumber(int i)
        {
