...
{
    public static final class GrowthRequestHeader extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final GrowthRequestHeader DEFAULT_INSTANCE;
        private static volatile Parser PARSER;
        public DeviceInfoProto.DeviceInfo deviceDescription_;
        public String pseudonymousId_;
        public ClientProto.Client queryingApplication_;

        public static GrowthRequestHeader parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (GrowthRequestHeader)obj;
        }
...
_L5:
            obj = new GrowthRequestHeader();
_L10:
            return obj;
_L6:
            return new Builder();
_L4:
            return new RawMessageInfo(DEFAULT_INSTANCE, "\000\003\000\000\001\003\003\000\000\000\001\u0208\002\t\003\t", new Object[] {
                "pseudonymousId_", "queryingApplication_", "deviceDescription_"
            });
_L7:
...
_L9:
            com/google/identity/boq/growth/common/proto/RequestHeader$GrowthRequestHeader;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new GrowthRequestHeader();
            GrowthRequestHeader growthrequestheader = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(com/google/identity/boq/growth/common/proto/RequestHeader$GrowthRequestHeader, growthrequestheader);
        }

        private GrowthRequestHeader()
        {
            pseudonymousId_ = "";
        }
    }

    public static final class GrowthRequestHeader.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        GrowthRequestHeader.Builder()
        {
            super(GrowthRequestHeader.DEFAULT_INSTANCE);
        }
    }
