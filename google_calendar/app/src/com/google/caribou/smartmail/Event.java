...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\005\000\001\003\016\005\000\000\001\003\b\001\006\u0409\b\f\t\003\r\t\004\016\t\013", new Object[] {
            "bitField0_", "name_", "address_", "startTime_", "endTime_", "image_"
        });
_L7:
...
_L9:
        com/google/caribou/smartmail/Event;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/caribou/smartmail/Event, event);
    }
}
