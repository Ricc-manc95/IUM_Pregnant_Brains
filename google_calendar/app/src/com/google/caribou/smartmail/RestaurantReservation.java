...
public final class RestaurantReservation extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RestaurantReservation.DEFAULT_INSTANCE);
        }
    }


    public static final RestaurantReservation DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public Restaurant foodEstablishment_;
    private byte memoizedIsInitialized;
    public int partySize_;
    ...
    public static RestaurantReservation parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (RestaurantReservation)obj;
    }
...
_L5:
        obj = new RestaurantReservation();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\007\n\003\000\000\001\007\t\003\t\u0409\001\n\004\004", new Object[] {
            "bitField0_", "startTime_", "foodEstablishment_", "partySize_"
        });
_L7:
...
_L9:
        com/google/caribou/smartmail/RestaurantReservation;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RestaurantReservation();
        RestaurantReservation restaurantreservation = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/caribou/smartmail/RestaurantReservation, restaurantreservation);
    }
}
