...
public final class EventReservation extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final class SeatingInformation extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final SeatingInformation DEFAULT_INSTANCE;
        ...
        public static SeatingInformation parseFrom(InputStream inputstream)
            throws IOException
        {
...
_L4:
            return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\b\000\002\b\001\003\b\002", new Object[] {
                "bitField0_", "seat_", "row_", "section_"
            });
_L7:
...
_L9:
            com/google/caribou/smartmail/EventReservation$SeatingInformation;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new SeatingInformation();
            SeatingInformation seatinginformation = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(com/google/caribou/smartmail/EventReservation$SeatingInformation, seatinginformation);
        }

        private SeatingInformation()
        {
            seat_ = "";
            row_ = "";
            section_ = "";
    ...
    public static final class SeatingInformation.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        SeatingInformation.Builder()
        {
            super(SeatingInformation.DEFAULT_INSTANCE);
        }
    }


    public static final EventReservation DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public Event event_;
    private byte memoizedIsInitialized;
    public String reservationNumber_;
    public int seatCount_;
    public com.google.protobuf.Internal.ProtobufList seatingInformation_;

    private EventReservation()
    {
        memoizedIsInitialized = 2;
        seatingInformation_ = ProtobufArrayList.EMPTY_LIST;
        reservationNumber_ = "";
    }

    public static EventReservation parseFrom(InputStream inputstream)
        throws IOException
    {
        Object obj = DEFAULT_INSTANCE;
        if (inputstream == null)
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\004\000\001\003\f\004\000\001\001\003\u0409\002\t\004\003\n\033\f\b\004", new Object[] {
            "bitField0_", "event_", "seatCount_", "seatingInformation_", com/google/caribou/smartmail/EventReservation$SeatingInformation, "reservationNumber_"
        });
_L7:
        return DEFAULT_INSTANCE;
_L8:
        ...
        if (parser != null) goto _L10; else goto _L9
_L9:
        com/google/caribou/smartmail/EventReservation;
        JVM INSTR monitorenter ;
        parser = PARSER;
        obj = parser;
        if (parser != null) goto _L12; else goto _L11
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new EventReservation();
        EventReservation eventreservation = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/caribou/smartmail/EventReservation, eventreservation);
    }
}
