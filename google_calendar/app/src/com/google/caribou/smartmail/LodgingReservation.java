...
//            Time, Image, Organization

public final class LodgingReservation extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(LodgingReservation.DEFAULT_INSTANCE);
        }
    }


    public static final LodgingReservation DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public Time checkinDate_;
    public Time checkoutDate_;
    public Image image_;
    public Organization lodging_;
    private byte memoizedIsInitialized;

    private LodgingReservation()
    {
        memoizedIsInitialized = 2;
    }

    public static LodgingReservation parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new LodgingReservation();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\004\000\001\b\013\004\000\000\001\b\t\003\t\t\004\n\u0409\002\013\t\005", new Object[] {
            "bitField0_", "checkinDate_", "checkoutDate_", "lodging_", "image_"
        });
_L7:
...
_L9:
        com/google/caribou/smartmail/LodgingReservation;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new LodgingReservation();
        LodgingReservation lodgingreservation = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/caribou/smartmail/LodgingReservation, lodgingreservation);
    }
}
