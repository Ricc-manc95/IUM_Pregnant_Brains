...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\b\003\000\000\000\001\b\000\007\b\001\b\b\002", new Object[] {
            "bitField0_", "name_", "firstName_", "lastName_"
        });
_L7:
...
_L9:
        com/google/caribou/smartmail/Person;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/caribou/smartmail/Person, person);
    }
}
