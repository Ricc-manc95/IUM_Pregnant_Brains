...
public final class EmailMessage extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static EmailMessage parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\001\004\004\001\000\000\001\004\u0409\002", new Object[] {
            "bitField0_", "publisher_"
        });
_L7:
...
_L9:
        com/google/caribou/smartmail/EmailMessage;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new EmailMessage();
        EmailMessage emailmessage = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/caribou/smartmail/EmailMessage, emailmessage);
    }
}
