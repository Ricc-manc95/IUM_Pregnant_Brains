...
//            FlightReservation, Event, LodgingReservation, RestaurantReservation, 
//            EventReservation, EmailMessage, Action

public final class SmartMailInfo extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(SmartMailInfo.DEFAULT_INSTANCE);
        }
    }


    public static final SmartMailInfo DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList action_;
    public int bitField0_;
    public com.google.protobuf.Internal.ProtobufList emailMessage_;
    public com.google.protobuf.Internal.ProtobufList eventReservation_;
    public com.google.protobuf.Internal.ProtobufList event_;
    public com.google.protobuf.Internal.ProtobufList flightReservation_;
    public com.google.protobuf.Internal.ProtobufList lodgingReservation_;
    private byte memoizedIsInitialized;
    public com.google.protobuf.Internal.ProtobufList restaurantReservation_;

    private SmartMailInfo()
    {
        memoizedIsInitialized = 2;
        emailMessage_ = ProtobufArrayList.EMPTY_LIST;
        action_ = ProtobufArrayList.EMPTY_LIST;
        event_ = ProtobufArrayList.EMPTY_LIST;
        eventReservation_ = ProtobufArrayList.EMPTY_LIST;
        flightReservation_ = ProtobufArrayList.EMPTY_LIST;
        lodgingReservation_ = ProtobufArrayList.EMPTY_LIST;
        restaurantReservation_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static SmartMailInfo parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new SmartMailInfo();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\007\000\001\003\016\007\000\007\006\003\033\005\u041B\006\u041B\007\u041B\t\u041B\f\u041B\016\u041B", new Object[] {
            "bitField0_", "flightReservation_", com/google/caribou/smartmail/FlightReservation, "event_", com/google/caribou/smartmail/Event, "lodgingReservation_", com/google/caribou/smartmail/LodgingReservation, "restaurantReservation_", com/google/caribou/smartmail/RestaurantReservation, "eventReservation_", 
            com/google/caribou/smartmail/EventReservation, "emailMessage_", com/google/caribou/smartmail/EmailMessage, "action_", com/google/caribou/smartmail/Action
        });
_L7:
...
_L9:
        com/google/caribou/smartmail/SmartMailInfo;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new SmartMailInfo();
        SmartMailInfo smartmailinfo = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/caribou/smartmail/SmartMailInfo, smartmailinfo);
    }
}
