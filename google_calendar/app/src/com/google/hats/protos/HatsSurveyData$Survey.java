...
// Referenced classes of package com.google.hats.protos:
//            HatsSurveyData

public static final class followUpUrl_ extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final ultInstanceMap DEFAULT_INSTANCE;
    ...
    public static der parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\007\000\001\004\n\007\000\000\000\004\007\002\005\b\003\006\b\004\007\b\005\b\b\006\t\b\007\n\b\b", new Object[] {
            "bitField0_", "showInvitation_", "promptMessage_", "thankYouMessage_", "promptParams_", "answerUrl_", "followUpMessage_", "followUpUrl_"
        });
_L7:
...
_L9:
        com/google/hats/protos/HatsSurveyData$Survey;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/hats/protos/HatsSurveyData$Survey, parser);
    }

    private DEFAULT_INSTANCE()
    {
        showInvitation_ = true;
        promptMessage_ = "";
        thankYouMessage_ = "";
        promptParams_ = "";
        answerUrl_ = "";
