...
{
    public static final class Survey extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final Survey DEFAULT_INSTANCE;
...
_L3:
        ...
        static 
        {
            ...
            Survey survey = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(com/google/hats/protos/HatsSurveyData$Survey, survey);
        }
    ...
    public static final class Survey.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {
    ...
    public static final class SurveyQuestionResponse extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final SurveyQuestionResponse DEFAULT_INSTANCE;
        private static volatile Parser PARSER;
        public int bitField0_;
        ...
        public com.google.protobuf.Internal.ProtobufList responses_;

        public static SurveyQuestionResponse parseFrom(InputStream inputstream)
            throws IOException
        {
            Object obj = DEFAULT_INSTANCE;
            if (inputstream == null)
            ...
            return (SurveyQuestionResponse)obj;
        }
...
_L1:
            throw new UnsupportedOperationException();
_L5:
            obj = new SurveyQuestionResponse();
_L10:
            return obj;
_L6:
            return new Builder();
_L4:
            return new RawMessageInfo(DEFAULT_INSTANCE, "\001\006\000\001\001\006\006\000\001\000\001\007\000\002\032\003\002\001\004\007\002\005\007\003\006\b\004", new Object[] {
                "bitField0_", "isAnswered_", "responses_", "delayMs_", "hasWriteIn_", "isSpammy_", "candidateForPipedResponse_"
            });
_L7:
            return DEFAULT_INSTANCE;
_L8:
            ...
            if (parser != null) goto _L10; else goto _L9
_L9:
            com/google/hats/protos/HatsSurveyData$SurveyQuestionResponse;
            JVM INSTR monitorenter ;
            parser = PARSER;
            obj = parser;
            if (parser != null) goto _L12; else goto _L11
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new SurveyQuestionResponse();
            SurveyQuestionResponse surveyquestionresponse = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(com/google/hats/protos/HatsSurveyData$SurveyQuestionResponse, surveyquestionresponse);
        }

        private SurveyQuestionResponse()
        {
            responses_ = ProtobufArrayList.EMPTY_LIST;
            delayMs_ = -1L;
            candidateForPipedResponse_ = "";
        }
    }

    public static final class SurveyQuestionResponse.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {
    ...
    public static final class SurveyResponse extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final SurveyResponse DEFAULT_INSTANCE;
        private static volatile Parser PARSER;
        public int bitField0_;
        public com.google.protobuf.Internal.ProtobufList questionResponse_;
        public int responseStatus_;
        public Survey survey_;

        public static SurveyResponse parseFrom(InputStream inputstream)
            throws IOException
        {
            Object obj = DEFAULT_INSTANCE;
            if (inputstream == null)
...
_L4:
            ...
            return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\001\000\001\f\000\002\t\001\003\033", new Object[] {
                "bitField0_", "responseStatus_", obj, "survey_", "questionResponse_", com/google/hats/protos/HatsSurveyData$SurveyQuestionResponse
            });
_L7:
            return DEFAULT_INSTANCE;
_L8:
            ...
            if (parser != null) goto _L10; else goto _L9
_L9:
            com/google/hats/protos/HatsSurveyData$SurveyResponse;
            JVM INSTR monitorenter ;
            parser = PARSER;
            obj = parser;
            if (parser != null) goto _L12; else goto _L11
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new SurveyResponse();
            SurveyResponse surveyresponse = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(com/google/hats/protos/HatsSurveyData$SurveyResponse, surveyresponse);
        }

        private SurveyResponse()
        {
            responseStatus_ = 1;
            questionResponse_ = ProtobufArrayList.EMPTY_LIST;
        }

        private class ResponseStatus extends Enum
            implements com.google.protobuf.Internal.EnumLite
        {

            private static final ResponseStatus $VALUES[];
            public static final ResponseStatus COMPLETE_ANSWER;
            public static final ResponseStatus PARTIAL_ANSWER;
            ...
            static 
            {
                COMPLETE_ANSWER = new ResponseStatus("COMPLETE_ANSWER", 0, 1);
                PARTIAL_ANSWER = new ResponseStatus("PARTIAL_ANSWER", 1, 2);
    ...
    public static final class SurveyResponse.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {
