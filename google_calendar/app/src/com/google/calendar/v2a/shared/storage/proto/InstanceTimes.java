...
public final class InstanceTimes extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final InstanceTimes DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public DisplayTime displayEnd_;
    public DisplayTime displayStart_;
    public long endInstant_;
    public boolean isAllDay_;
    public long rawEndMs_;
    public long rawStartMs_;
    public long startInstant_;

    private InstanceTimes()
    {
    }

    public static InstanceTimes parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new InstanceTimes();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\007\000\001\001\007\007\000\000\000\001\t\001\002\002\002\003\t\004\004\002\005\005\002\003\006\002\006\007\007\0", new Object[] {
            "bitField0_", "displayStart_", "startInstant_", "displayEnd_", "endInstant_", "rawStartMs_", "rawEndMs_", "isAllDay_"
        });
_L7:
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/InstanceTimes;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new InstanceTimes();
        InstanceTimes instancetimes = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/InstanceTimes, instancetimes);
    }
}
