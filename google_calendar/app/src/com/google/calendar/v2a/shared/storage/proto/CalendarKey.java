...
public final class CalendarKey extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(CalendarKey.DEFAULT_INSTANCE);
        }
    }


    public static final CalendarKey DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public AccountKey accountKey_;
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\t\000\002\b\001", new Object[] {
            "bitField0_", "accountKey_", "calendarId_"
        });
_L7:
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/CalendarKey;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new CalendarKey();
        CalendarKey calendarkey = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/CalendarKey, calendarkey);
    }
}
