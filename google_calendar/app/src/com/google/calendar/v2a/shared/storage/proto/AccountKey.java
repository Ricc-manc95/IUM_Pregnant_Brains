...
public final class AccountKey extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final AccountKey DEFAULT_INSTANCE;
    ...
    public static AccountKey parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/AccountKey;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new AccountKey();
        AccountKey accountkey = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/AccountKey, accountkey);
    }
}
