...
//            CalendarKey, DayRange

public final class GetEventsRequest extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final GetEventsRequest DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public com.google.protobuf.Internal.ProtobufList calendarKey_;
    public DayRange dayRange_;

    private GetEventsRequest()
    {
        calendarKey_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static GetEventsRequest parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\001\000\001\033\002\t\0", new Object[] {
            "bitField0_", "calendarKey_", com/google/calendar/v2a/shared/storage/proto/CalendarKey, "dayRange_"
        });
_L7:
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/GetEventsRequest;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new GetEventsRequest();
        GetEventsRequest geteventsrequest = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/GetEventsRequest, geteventsrequest);
    }
}
