...
// Referenced classes of package com.google.calendar.v2a.shared.storage.proto:
//            EventInstance, CalendarKey, InstanceTimes

public final class EventBundle extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(EventBundle.DEFAULT_INSTANCE);
        }
    }


    public static final EventBundle DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public Event baseEvent_;
    public int bitField0_;
    public CalendarKey calendarKey_;
    public com.google.protobuf.Internal.ProtobufList eventInstances_;
    public InstanceTimes firstSeriesInstanceTimes_;
    private byte memoizedIsInitialized;
    public RecurrenceData recurrenceData_;

    private EventBundle()
    {
        memoizedIsInitialized = 2;
        eventInstances_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static EventBundle parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\005\000\001\001\005\005\000\001\001\001\t\000\002\u0409\001\003\t\002\004\033\005\t\003", new Object[] {
            "bitField0_", "calendarKey_", "baseEvent_", "recurrenceData_", "eventInstances_", com/google/calendar/v2a/shared/storage/proto/EventInstance, "firstSeriesInstanceTimes_"
        });
_L7:
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/EventBundle;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new EventBundle();
        EventBundle eventbundle = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/EventBundle, eventbundle);
    }
}
