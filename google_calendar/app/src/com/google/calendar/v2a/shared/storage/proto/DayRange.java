...
public final class DayRange extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final DayRange DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public int firstDay_;
    public int lastDay_;
    ...
    public static DayRange parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\004\000\002\004\001\003\b\002", new Object[] {
            "bitField0_", "firstDay_", "lastDay_", "timeZone_"
        });
_L7:
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/DayRange;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new DayRange();
        DayRange dayrange = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/DayRange, dayrange);
    }
}
