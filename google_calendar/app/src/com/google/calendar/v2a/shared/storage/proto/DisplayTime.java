...
public final class DisplayTime extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(DisplayTime.DEFAULT_INSTANCE);
        }
    }


    public static final DisplayTime DEFAULT_INSTANCE;
    ...
    public static DisplayTime parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/DisplayTime;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new DisplayTime();
        DisplayTime displaytime = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/DisplayTime, displaytime);
    }
}
