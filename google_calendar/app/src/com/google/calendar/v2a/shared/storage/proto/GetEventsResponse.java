...
public final class GetEventsResponse extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final GetEventsResponse DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList eventBundle_;
    private byte memoizedIsInitialized;

    private GetEventsResponse()
    {
        memoizedIsInitialized = 2;
        eventBundle_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static GetEventsResponse parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new GetEventsResponse();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\000\001\001\001\000\001\001\001\u041B", new Object[] {
            "eventBundle_", com/google/calendar/v2a/shared/storage/proto/EventBundle
        });
_L7:
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/GetEventsResponse;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new GetEventsResponse();
        GetEventsResponse geteventsresponse = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/GetEventsResponse, geteventsresponse);
    }
}
