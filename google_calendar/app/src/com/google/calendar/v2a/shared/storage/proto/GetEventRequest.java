...
public final class GetEventRequest extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final GetEventRequest DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public EventKey eventKey_;

    private GetEventRequest()
    {
    }

    public static GetEventRequest parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/GetEventRequest;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new GetEventRequest();
        GetEventRequest geteventrequest = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/GetEventRequest, geteventrequest);
    }
}
