...
public final class EventKey extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(EventKey.DEFAULT_INSTANCE);
        }
    }


    public static final EventKey DEFAULT_INSTANCE;
    ...
    public static EventKey parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\t\000\002\b\001", new Object[] {
            "bitField0_", "calendarKey_", "eventId_"
        });
_L7:
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/EventKey;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new EventKey();
        EventKey eventkey = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/EventKey, eventkey);
    }
}
