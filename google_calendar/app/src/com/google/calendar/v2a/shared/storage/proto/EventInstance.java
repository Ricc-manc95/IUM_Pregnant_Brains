...
public final class EventInstance extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(EventInstance.DEFAULT_INSTANCE);
        }
    }


    public static final EventInstance DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public String eventId_;
    public InstanceTimes localTimes_;
    ...
    public static EventInstance parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\b\000\002\t\001", new Object[] {
            "bitField0_", "eventId_", "localTimes_"
        });
_L7:
...
_L9:
        com/google/calendar/v2a/shared/storage/proto/EventInstance;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new EventInstance();
        EventInstance eventinstance = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2a/shared/storage/proto/EventInstance, eventinstance);
    }
}
