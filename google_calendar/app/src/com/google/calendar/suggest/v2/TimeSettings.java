...
public final class TimeSettings extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TimeSettings.DEFAULT_INSTANCE);
        }
    }

    public static final class TimeframeType extends Enum
        implements com.google.protobuf.Internal.EnumLite
    {

        private static final TimeframeType $VALUES[];
        public static final TimeframeType AROUND_DATE;
        private static final TimeframeType EXACT_WINDOW;
        private static final TimeframeType MULTIPLE_WINDOWS;
        public static final TimeframeType UNRECOGNIZED;
        ...
        public static TimeframeType[] values()
        {
            return (TimeframeType[])$VALUES.clone();
        }
        ...
        static 
        {
            EXACT_WINDOW = new TimeframeType("EXACT_WINDOW", 0, 0);
            AROUND_DATE = new TimeframeType("AROUND_DATE", 1, 1);
            MULTIPLE_WINDOWS = new TimeframeType("MULTIPLE_WINDOWS", 2, 2);
            UNRECOGNIZED = new TimeframeType("UNRECOGNIZED", 3, -1);
            $VALUES = (new TimeframeType[] {
        ...
        private TimeframeType(String s, int i, int j)
        {
            super(s, i);
            value = j;
        }
    ...
    public static final TimeSettings DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public Duration duration_;
    public int timeframeType_;
    public Timestamp windowEndTime_;
    public Timestamp windowStartTime_;

    private TimeSettings()
    {
    }

    public static TimeSettings parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new TimeSettings();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\004\000\001\001\004\004\000\000\000\001\t\002\t\003\t\004\f", new Object[] {
            "bitField0_", "duration_", "windowStartTime_", "windowEndTime_", "timeframeType_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/TimeSettings;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TimeSettings();
        TimeSettings timesettings = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/TimeSettings, timesettings);
    }
}
