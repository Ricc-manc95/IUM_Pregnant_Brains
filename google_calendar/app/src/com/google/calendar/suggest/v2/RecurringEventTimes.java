...
public final class RecurringEventTimes extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RecurringEventTimes.DEFAULT_INSTANCE);
        }
    }


    public static final RecurringEventTimes DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public boolean considerExceptions_;
    public SingleEventTime firstEventTime_;
    public int recurrenceSpecCase_;
    public Object recurrenceSpec_;
    public String timezone_;

    private RecurringEventTimes()
    {
        recurrenceSpecCase_ = 0;
        timezone_ = "";
    }

    public static RecurringEventTimes parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (RecurringEventTimes)obj;
    }
...
_L5:
        obj = new RecurringEventTimes();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\005\001\000\001\005\005\000\000\000\001\t\002\u0208\003\u023B\000\004\007\005<\0", new Object[] {
            "recurrenceSpec_", "recurrenceSpecCase_", "firstEventTime_", "timezone_", "considerExceptions_", com/google/calendar/v2/libs/proto/RecurrenceProto$RecurrenceData
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/RecurringEventTimes;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RecurringEventTimes();
        RecurringEventTimes recurringeventtimes = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/RecurringEventTimes, recurringeventtimes);
    }
}
