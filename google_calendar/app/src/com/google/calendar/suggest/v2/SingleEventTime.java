...
public final class SingleEventTime extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(SingleEventTime.DEFAULT_INSTANCE);
        }
    }


    public static final SingleEventTime DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public boolean allDay_;
    public Timestamp endTime_;
    public Timestamp startTime_;

    private SingleEventTime()
    {
    }

    public static SingleEventTime parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new SingleEventTime();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\003\000\000\001\003\003\000\000\000\001\t\002\t\003\007", new Object[] {
            "startTime_", "endTime_", "allDay_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/SingleEventTime;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new SingleEventTime();
        SingleEventTime singleeventtime = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/SingleEventTime, singleeventtime);
    }
}
