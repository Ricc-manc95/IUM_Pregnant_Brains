...
//            RoomSuggestion, AttendeeGroup

public final class RoomRecommendationsResults extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RoomRecommendationsResults.DEFAULT_INSTANCE);
        }
    }


    public static final RoomRecommendationsResults DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList locations_;
    public com.google.protobuf.Internal.ProtobufList recommendedRooms_;

    private RoomRecommendationsResults()
    {
        locations_ = ProtobufArrayList.EMPTY_LIST;
        recommendedRooms_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static RoomRecommendationsResults parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (RoomRecommendationsResults)obj;
    }
...
_L5:
        obj = new RoomRecommendationsResults();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\002\000\000\001\002\002\000\002\000\001\033\002\033", new Object[] {
            "recommendedRooms_", com/google/calendar/suggest/v2/RoomSuggestion, "locations_", com/google/calendar/suggest/v2/AttendeeGroup
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/RoomRecommendationsResults;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RoomRecommendationsResults();
        RoomRecommendationsResults roomrecommendationsresults = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/RoomRecommendationsResults, roomrecommendationsresults);
    }
}
