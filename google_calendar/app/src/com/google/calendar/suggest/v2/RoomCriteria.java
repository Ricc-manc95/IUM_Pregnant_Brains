...
public final class RoomCriteria extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RoomCriteria.DEFAULT_INSTANCE);
        }
    }


    public static final RoomCriteria DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList attendees_;
    public int bitField0_;
    public int numSeats_;
    public String preferredBuildingId_;
    public String preferredBuildingName_;
    public String preferredFloor_;

    private RoomCriteria()
    {
        attendees_ = ProtobufArrayList.EMPTY_LIST;
        preferredBuildingName_ = "";
        preferredBuildingId_ = "";
        preferredFloor_ = "";
    }

    public static RoomCriteria parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new RoomCriteria();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\005\000\001\001\005\005\000\001\000\001\033\002\u0208\003\u0208\004\004\005\u0208", new Object[] {
            "bitField0_", "attendees_", com/google/calendar/suggest/v2/Attendee, "preferredBuildingName_", "preferredFloor_", "numSeats_", "preferredBuildingId_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/RoomCriteria;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RoomCriteria();
        RoomCriteria roomcriteria = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/RoomCriteria, roomcriteria);
    }
}
