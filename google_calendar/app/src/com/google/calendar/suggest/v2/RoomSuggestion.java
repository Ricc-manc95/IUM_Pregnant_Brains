...
public final class RoomSuggestion extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements com.google.protobuf.Internal.EnumLite
    {
        ...
        public static final Availability UNRECOGNIZED;
        ...
        static 
        {
            ...
            UNAVAILABLE = new Availability("UNAVAILABLE", 2, 2);
            UNRECOGNIZED = new Availability("UNRECOGNIZED", 3, -1);
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RoomSuggestion.DEFAULT_INSTANCE);
        }
    }


    public static final RoomSuggestion DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int availability_;
    public Room room_;

    private RoomSuggestion()
    {
    }

    public static RoomSuggestion parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L9:
        com/google/calendar/suggest/v2/RoomSuggestion;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RoomSuggestion();
        RoomSuggestion roomsuggestion = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/RoomSuggestion, roomsuggestion);
    }
}
