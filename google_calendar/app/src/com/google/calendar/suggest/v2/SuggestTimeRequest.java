...
//            Attendee, CalendarEvent, TimeSettings, UserContext

public final class SuggestTimeRequest extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(SuggestTimeRequest.DEFAULT_INSTANCE);
        }
    }


    public static final SuggestTimeRequest DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList attendees_;
    public int bitField0_;
    public boolean considerRooms_;
    public String eventReference_;
    public CalendarEvent existingEvent_;
    public boolean expandGroupAttendees_;
    public boolean includeAttendeesEvents_;
    public int maxResults_;
    public TimeSettings timeSettings_;
    public boolean useExplanationType_;
    public UserContext userContext_;

    private SuggestTimeRequest()
    {
        attendees_ = ProtobufArrayList.EMPTY_LIST;
        eventReference_ = "";
    }

    public static SuggestTimeRequest parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new SuggestTimeRequest();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\n\000\001\001\f\n\000\001\000\001\033\002\t\003\t\004\007\005\004\006\t\t\007\n\u0208\013\007\f\007", new Object[] {
            "bitField0_", "attendees_", com/google/calendar/suggest/v2/Attendee, "timeSettings_", "userContext_", "includeAttendeesEvents_", "maxResults_", "existingEvent_", "considerRooms_", "eventReference_", 
            "expandGroupAttendees_", "useExplanationType_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/SuggestTimeRequest;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new SuggestTimeRequest();
        SuggestTimeRequest suggesttimerequest = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/SuggestTimeRequest, suggesttimerequest);
    }
}
