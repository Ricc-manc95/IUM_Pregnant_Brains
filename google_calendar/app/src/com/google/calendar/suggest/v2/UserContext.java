...
public final class UserContext extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final UserContext DEFAULT_INSTANCE;
    ...
    public static UserContext parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\002\000\000\001\002\002\000\000\000\001\u0208\002\u0208", new Object[] {
            "locale_", "timezone_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/UserContext;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new UserContext();
        UserContext usercontext = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/UserContext, usercontext);
    }
}
