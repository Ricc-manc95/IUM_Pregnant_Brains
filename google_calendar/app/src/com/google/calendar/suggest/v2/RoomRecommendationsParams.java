...
public final class RoomRecommendationsParams extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RoomRecommendationsParams.DEFAULT_INSTANCE);
        }
    }


    public static final RoomRecommendationsParams DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public com.google.protobuf.Internal.ProtobufList criteria_;
    public int maxSuggestions_;
    public boolean preferLocationBasedSuggestions_;
    public boolean showUnavailable_;
    public boolean smartRestrictMax_;

    private RoomRecommendationsParams()
    {
        criteria_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static RoomRecommendationsParams parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (RoomRecommendationsParams)obj;
    }
...
_L5:
        obj = new RoomRecommendationsParams();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\005\000\001\001\005\005\000\001\000\001\004\002\007\003\007\004\007\005\033", new Object[] {
            "bitField0_", "maxSuggestions_", "smartRestrictMax_", "showUnavailable_", "preferLocationBasedSuggestions_", "criteria_", com/google/calendar/suggest/v2/RoomCriteria
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/RoomRecommendationsParams;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RoomRecommendationsParams();
        RoomRecommendationsParams roomrecommendationsparams = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/RoomRecommendationsParams, roomrecommendationsparams);
    }
}
