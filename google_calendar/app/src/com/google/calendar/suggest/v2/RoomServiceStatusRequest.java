...
public final class RoomServiceStatusRequest extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RoomServiceStatusRequest.DEFAULT_INSTANCE);
        }
    }


    public static final RoomServiceStatusRequest DEFAULT_INSTANCE;
    private static volatile Parser PARSER;

    private RoomServiceStatusRequest()
    {
    }

    public static RoomServiceStatusRequest parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (RoomServiceStatusRequest)obj;
    }
...
_L5:
        obj = new RoomServiceStatusRequest();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\0", null);
_L7:
...
_L9:
        com/google/calendar/suggest/v2/RoomServiceStatusRequest;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RoomServiceStatusRequest();
        RoomServiceStatusRequest roomservicestatusrequest = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/RoomServiceStatusRequest, roomservicestatusrequest);
    }
}
