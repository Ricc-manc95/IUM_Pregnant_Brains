...
//            Explanation, SingleEventTime

public final class TimeSuggestion extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TimeSuggestion.DEFAULT_INSTANCE);
        }
    }


    public static final TimeSuggestion DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList attendeeExplanations_;
    public int bitField0_;
    public SingleEventTime eventTime_;
    public String explanationMessage_;
    public String suggestionId_;

    private TimeSuggestion()
    {
        suggestionId_ = "";
        explanationMessage_ = "";
        attendeeExplanations_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static TimeSuggestion parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new TimeSuggestion();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\004\000\001\001\006\004\000\001\000\001\t\002\033\004\u0208\006\u0208", new Object[] {
            "bitField0_", "eventTime_", "attendeeExplanations_", com/google/calendar/suggest/v2/Explanation, "suggestionId_", "explanationMessage_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/TimeSuggestion;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TimeSuggestion();
        TimeSuggestion timesuggestion = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/TimeSuggestion, timesuggestion);
    }
}
