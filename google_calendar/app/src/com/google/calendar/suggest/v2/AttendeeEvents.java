...
public final class AttendeeEvents extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(AttendeeEvents.DEFAULT_INSTANCE);
        }
    }


    public static final AttendeeEvents DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public Attendee attendee_;
    public int bitField0_;
    public com.google.protobuf.Internal.ProtobufList events_;

    private AttendeeEvents()
    {
        events_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static AttendeeEvents parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new AttendeeEvents();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\002\000\001\001\002\002\000\001\000\001\t\002\033", new Object[] {
            "bitField0_", "attendee_", "events_", com/google/calendar/suggest/v2/Event
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/AttendeeEvents;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new AttendeeEvents();
        AttendeeEvents attendeeevents = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/AttendeeEvents, attendeeevents);
    }
}
