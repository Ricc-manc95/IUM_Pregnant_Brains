...
public final class OmittedAttendee extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(OmittedAttendee.DEFAULT_INSTANCE);
        }
    }
        ...
        implements com.google.protobuf.Internal.EnumLite
    {
        ...
        public static final Reason FAILED;
        public static final Reason IGNORED;
        ...
        static 
        {
            FAILED = new Reason("FAILED", 0, 0);
            IGNORED = new Reason("IGNORED", 1, 1);
            NOT_FOUND = new Reason("NOT_FOUND", 2, 2);
            UNRECOGNIZED = new Reason("UNRECOGNIZED", 3, -1);
            $VALUES = (new Reason[] {
        ...
        private Reason(String s, int i, int j)
        {
            super(s, i);
            value = j;
        }
    ...
    public static final OmittedAttendee DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public Attendee attendee_;
    public int reason_;

    private OmittedAttendee()
    {
    }

    public static OmittedAttendee parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new OmittedAttendee();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\002\000\000\001\002\002\000\000\000\001\t\002\f", new Object[] {
            "attendee_", "reason_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/OmittedAttendee;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new OmittedAttendee();
        OmittedAttendee omittedattendee = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/OmittedAttendee, omittedattendee);
    }
}
