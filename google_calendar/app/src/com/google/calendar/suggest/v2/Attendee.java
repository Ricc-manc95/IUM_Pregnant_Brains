...
public final class Attendee extends GeneratedMessageLite
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\003\000\000\001\003\003\000\000\000\001\u0208\002\007\003\f", new Object[] {
            "email_", "organizer_", "responseStatus_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/Attendee;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/Attendee, attendee);
    }
}
