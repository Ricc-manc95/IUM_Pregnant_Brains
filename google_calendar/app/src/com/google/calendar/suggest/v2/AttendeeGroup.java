...
//            RoomSuggestion, RoomCriteria

public final class AttendeeGroup extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(AttendeeGroup.DEFAULT_INSTANCE);
        }
    }


    public static final AttendeeGroup DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public RoomCriteria criteria_;
    public String displayName_;
    public String hierarchyNodeId_;
    public com.google.protobuf.Internal.ProtobufList roomSuggestions_;

    private AttendeeGroup()
    {
        roomSuggestions_ = ProtobufArrayList.EMPTY_LIST;
        displayName_ = "";
        hierarchyNodeId_ = "";
    }

    public static AttendeeGroup parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new AttendeeGroup();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\004\000\001\002\t\004\000\001\000\002\033\003\t\b\u0208\t\u0208", new Object[] {
            "bitField0_", "roomSuggestions_", com/google/calendar/suggest/v2/RoomSuggestion, "criteria_", "displayName_", "hierarchyNodeId_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/AttendeeGroup;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new AttendeeGroup();
        AttendeeGroup attendeegroup = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/AttendeeGroup, attendeegroup);
    }
}
