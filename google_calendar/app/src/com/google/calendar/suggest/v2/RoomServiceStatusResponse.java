...
public final class RoomServiceStatusResponse extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RoomServiceStatusResponse.DEFAULT_INSTANCE);
        }
    }


    public static final RoomServiceStatusResponse DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public boolean roomServiceEnabled_;

    private RoomServiceStatusResponse()
    {
    }

    public static RoomServiceStatusResponse parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (RoomServiceStatusResponse)obj;
    }
...
_L5:
        obj = new RoomServiceStatusResponse();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\001\000\000\001\001\001\000\000\000\001\007", new Object[] {
            "roomServiceEnabled_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/RoomServiceStatusResponse;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RoomServiceStatusResponse();
        RoomServiceStatusResponse roomservicestatusresponse = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/RoomServiceStatusResponse, roomservicestatusresponse);
    }
}
