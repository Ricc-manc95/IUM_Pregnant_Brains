...
public final class RoomAttendee extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RoomAttendee.DEFAULT_INSTANCE);
        }
    }


    public static final RoomAttendee DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public String email_;
    public int responseStatus_;

    private RoomAttendee()
    {
        email_ = "";
    }

    public static RoomAttendee parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new RoomAttendee();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\002\000\000\001\003\002\000\000\000\001\u0208\003\f", new Object[] {
            "email_", "responseStatus_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/RoomAttendee;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RoomAttendee();
        RoomAttendee roomattendee = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/RoomAttendee, roomattendee);
    }
}
