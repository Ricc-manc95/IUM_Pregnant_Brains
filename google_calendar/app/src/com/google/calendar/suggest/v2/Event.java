...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\007\000\000\002\b\007\000\000\000\002\u0208\003\t\004\u0208\005\007\006\007\007\007\b\u0208", new Object[] {
            "eventId_", "time_", "summary_", "private_", "declined_", "transparent_", "location_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/Event;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/Event, event);
    }
}
