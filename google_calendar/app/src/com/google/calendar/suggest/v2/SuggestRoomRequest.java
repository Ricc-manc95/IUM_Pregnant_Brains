...
//            SingleEventTime, RecurringEventTimes, Attendee, RoomAttendee, 
//            CalendarEvent, RoomListingParams, RoomRecommendationsParams

public final class SuggestRoomRequest extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(SuggestRoomRequest.DEFAULT_INSTANCE);
        }
    }


    public static final SuggestRoomRequest DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList attendees_;
    public int bitField0_;
    public String buildingId_;
    public String eventReference_;
    public CalendarEvent existingEvent_;
    public String hierarchyNodeId_;
    public RoomListingParams listingParams_;
    public String query_;
    public RoomRecommendationsParams recommendationsParams_;
    public com.google.protobuf.Internal.ProtobufList selectedRooms_;
    public int timesCase_;
    public Object times_;

    private SuggestRoomRequest()
    {
        timesCase_ = 0;
        query_ = "";
        attendees_ = ProtobufArrayList.EMPTY_LIST;
        selectedRooms_ = ProtobufArrayList.EMPTY_LIST;
        hierarchyNodeId_ = "";
        buildingId_ = "";
        eventReference_ = "";
    }

    public static SuggestRoomRequest parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new SuggestRoomRequest();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\013\001\001\001\f\013\000\002\000\001\u0208\002<\000\003<\000\004\t\005\033\006\033\007\u0208\t\t\n\t\013\u0208\f\u0208", new Object[] {
            "times_", "timesCase_", "bitField0_", "query_", com/google/calendar/suggest/v2/SingleEventTime, com/google/calendar/suggest/v2/RecurringEventTimes, "existingEvent_", "attendees_", com/google/calendar/suggest/v2/Attendee, "selectedRooms_", 
            com/google/calendar/suggest/v2/RoomAttendee, "hierarchyNodeId_", "recommendationsParams_", "listingParams_", "eventReference_", "buildingId_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/SuggestRoomRequest;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new SuggestRoomRequest();
        SuggestRoomRequest suggestroomrequest = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/SuggestRoomRequest, suggestroomrequest);
    }
}
