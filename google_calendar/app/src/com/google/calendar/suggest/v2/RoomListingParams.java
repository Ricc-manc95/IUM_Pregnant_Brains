...
public final class RoomListingParams extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RoomListingParams.DEFAULT_INSTANCE);
        }
    }


    public static final RoomListingParams DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int maxResultsPerPage_;
    public String pageToken_;
    public boolean preferHierarchy_;
    public boolean showUnavailable_;

    private RoomListingParams()
    {
        pageToken_ = "";
    }

    public static RoomListingParams parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new RoomListingParams();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\004\000\000\001\004\004\000\000\000\001\007\002\004\003\007\004\u0208", new Object[] {
            "preferHierarchy_", "maxResultsPerPage_", "showUnavailable_", "pageToken_"
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/RoomListingParams;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RoomListingParams();
        RoomListingParams roomlistingparams = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/RoomListingParams, roomlistingparams);
    }
}
