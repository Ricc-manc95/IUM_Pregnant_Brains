...
//            RoomSuggestion, RoomListingResults, RoomRecommendationsResults

public final class SuggestRoomResponse extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(SuggestRoomResponse.DEFAULT_INSTANCE);
        }
    }


    public static final SuggestRoomResponse DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public RoomListingResults listingResults_;
    public int matchingRoomsCount_;
    public RoomRecommendationsResults recommendationsResults_;
    public com.google.protobuf.Internal.ProtobufList resolvedSelectedRooms_;
    public String responseId_;

    private SuggestRoomResponse()
    {
        responseId_ = "";
        resolvedSelectedRooms_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static SuggestRoomResponse parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (SuggestRoomResponse)obj;
    }
...
_L5:
        obj = new SuggestRoomResponse();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\000\005\000\001\001\006\005\000\001\000\001\t\002\t\003\u0208\004\004\006\033", new Object[] {
            "bitField0_", "listingResults_", "recommendationsResults_", "responseId_", "matchingRoomsCount_", "resolvedSelectedRooms_", com/google/calendar/suggest/v2/RoomSuggestion
        });
_L7:
...
_L9:
        com/google/calendar/suggest/v2/SuggestRoomResponse;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new SuggestRoomResponse();
        SuggestRoomResponse suggestroomresponse = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/suggest/v2/SuggestRoomResponse, suggestroomresponse);
    }
}
