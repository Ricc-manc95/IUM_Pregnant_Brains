...
// Referenced classes of package com.google.calendar.v2.libs.proto:
//            DirectoryProto

public static final class religionHoliday_ extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(DirectoryProto.Directory.DEFAULT_INSTANCE);
        }
    }
    ...
    public com.google.protobuf.oto.Directory countryHoliday_;
    public com.google.protobuf.oto.Directory religionHoliday_;

    public static Builder parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        {
            inputstream = new com.google.protobuf.coder(inputstream, 4096);
        }
        ...
        if (obj != null)
        {
            ...
            } else
            {
                ...
                if (flag1)
                {
                    int i = android.support.v4.content.T_MEMOIZED_IS_INITIALIZED._fld9HHMUR9FCTNMUPRCCKNN0SJFEHNM4TB65T3MARJ5E9GN8PB49LIN6SR1CTIKOQBKCKI4QPBKD1NM8L3F95N7CRRBCKTG____0;
                    if (flag)
                    {
...
_L11:
        obj = new com.google.protobuf.ultInstanceBasedParser(DEFAULT_INSTANCE);
        PARSER = ((Parser) (obj));
_L12:
        com/google/calendar/v2/libs/proto/DirectoryProto$Directory;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2/libs/proto/DirectoryProto$Directory, parser);
    }
