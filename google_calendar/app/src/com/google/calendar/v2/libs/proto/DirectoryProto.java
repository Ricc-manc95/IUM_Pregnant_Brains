...
{
    public static final class Directory extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final Directory DEFAULT_INSTANCE;
        private static volatile Parser PARSER;
        public int bitField0_;
        public com.google.protobuf.Internal.ProtobufList countryHoliday_;
        public com.google.protobuf.Internal.ProtobufList religionHoliday_;

        public static Directory parseFrom(InputStream inputstream)
            throws IOException
        {
...
_L6:
            return new Builder();
_L4:
            return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\002\000\001\033\002\033", new Object[] {
                "bitField0_", "countryHoliday_", com/google/calendar/v2/libs/proto/DirectoryProto$DirectoryEntry, "religionHoliday_", com/google/calendar/v2/libs/proto/DirectoryProto$DirectoryEntry
            });
_L7:
...
_L9:
            com/google/calendar/v2/libs/proto/DirectoryProto$Directory;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new Directory();
            Directory directory = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2/libs/proto/DirectoryProto$Directory, directory);
        }

        private Directory()
        {
            countryHoliday_ = ProtobufArrayList.EMPTY_LIST;
            religionHoliday_ = ProtobufArrayList.EMPTY_LIST;
        }
    }

    public static final class Directory.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        Directory.Builder()
        {
            super(Directory.DEFAULT_INSTANCE);
        }
    }

    public static final class DirectoryEntry extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final DirectoryEntry DEFAULT_INSTANCE;
        private static volatile Parser PARSER;
        public int bitField0_;
        ...
        public static DirectoryEntry parseFrom(InputStream inputstream)
            throws IOException
        {
            Object obj = DEFAULT_INSTANCE;
            if (inputstream == null)
...
_L8:
            ...
            if (parser != null) goto _L10; else goto _L9
_L9:
            com/google/calendar/v2/libs/proto/DirectoryProto$DirectoryEntry;
            JVM INSTR monitorenter ;
            parser = PARSER;
            obj = parser;
            if (parser != null) goto _L12; else goto _L11
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new DirectoryEntry();
            DirectoryEntry directoryentry = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2/libs/proto/DirectoryProto$DirectoryEntry, directoryentry);
        }
    ...
    public static final class DirectoryEntry.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        DirectoryEntry.Builder()
        {
            super(DirectoryEntry.DEFAULT_INSTANCE);
        }
    }
