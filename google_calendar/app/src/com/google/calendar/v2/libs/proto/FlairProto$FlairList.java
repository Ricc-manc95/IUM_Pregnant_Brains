...
public static final class flair_ extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(FlairProto.FlairList.DEFAULT_INSTANCE);
        }
    }
    ...
    public com.google.protobuf. flair_;
        ...
        throws IOException
    {
        ...
        {
            inputstream = new com.google.protobuf.amDecoder(inputstream, 4096);
        }
        ...
        if (obj != null)
        {
            ...
            } else
            {
                ...
                if (flag1)
                {
                    int i = android.support.v4.content.s.SET_MEMOIZED_IS_INITIALIZED._fld9HHMUR9FCTNMUPRCCKNN0SJFEHNM4TB65T3MARJ5E9GN8PB49LIN6SR1CTIKOQBKCKI4QPBKD1NM8L3F95N7CRRBCKTG____0;
                    if (flag)
                    {
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/v2/libs/proto/FlairProto$FlairList, memoizedisinitialized);
    }
