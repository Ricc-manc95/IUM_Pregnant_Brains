...
//            UssExperimentFlags, AndroidSharedPref

public final class UssClientState extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(UssClientState.DEFAULT_INSTANCE);
        }
    }


    public static final UssClientState DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public UssExperimentFlags flags_;
    public AndroidSharedPref isCalendarEventsReady_;
    public AndroidSharedPref isHabitsSettingsReady_;

    private UssClientState()
    {
    }

    public static UssClientState parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new UssClientState();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\t\000\002\t\001\003\t\002", new Object[] {
            "bitField0_", "flags_", "isHabitsSettingsReady_", "isCalendarEventsReady_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/UssClientState;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new UssClientState();
        UssClientState ussclientstate = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/UssClientState, ussclientstate);
    }
}
