...
//            CalendarEvent, ConferenceMetadata, PendingCalendarEvent

public final class CalendarClientVisualElementMetadata extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(CalendarClientVisualElementMetadata.DEFAULT_INSTANCE);
        }
    }


    public static final CalendarClientVisualElementMetadata DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public CalendarEvent calendarEvent_;
    public ConferenceMetadata conferenceMetadata_;
    public PendingCalendarEvent pendingCalendarEvent_;

    private CalendarClientVisualElementMetadata()
    {
    }

    public static CalendarClientVisualElementMetadata parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (CalendarClientVisualElementMetadata)obj;
    }
...
_L5:
        obj = new CalendarClientVisualElementMetadata();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\002\004\003\000\000\000\002\t\001\003\t\002\004\t\003", new Object[] {
            "bitField0_", "calendarEvent_", "pendingCalendarEvent_", "conferenceMetadata_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/CalendarClientVisualElementMetadata;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new CalendarClientVisualElementMetadata();
        CalendarClientVisualElementMetadata calendarclientvisualelementmetadata = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/CalendarClientVisualElementMetadata, calendarclientvisualelementmetadata);
    }
}
