...
public final class CustomTimeInfo extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(CustomTimeInfo.DEFAULT_INSTANCE);
        }
    }


    public static final CustomTimeInfo DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public long endTimeMillis_;
    public long startTimeMillis_;

    private CustomTimeInfo()
    {
    }

    public static CustomTimeInfo parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new CustomTimeInfo();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\002\000\002\002\001", new Object[] {
            "bitField0_", "startTimeMillis_", "endTimeMillis_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/CustomTimeInfo;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new CustomTimeInfo();
        CustomTimeInfo customtimeinfo = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/CustomTimeInfo, customtimeinfo);
    }
}
