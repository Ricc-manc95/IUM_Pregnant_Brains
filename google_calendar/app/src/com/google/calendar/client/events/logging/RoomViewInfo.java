...
public final class RoomViewInfo extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RoomViewInfo.DEFAULT_INSTANCE);
        }
    }
        ...
        implements com.google.protobuf.Internal.EnumLite
    {
        ...
        public static final ListingType FLAT;
        public static final ListingType HIERARCHICAL;
        ...
        public static ListingType forNumber(int i)
        {
            switch (i)
            {
            default:
        ...
        static 
        {
            UNKNOWN = new ListingType("UNKNOWN", 0, 0);
            FLAT = new ListingType("FLAT", 1, 1);
            HIERARCHICAL = new ListingType("HIERARCHICAL", 2, 2);
                ...
                implements com.google.protobuf.Internal.EnumVerifier
            {
                ...
                {
                    return ListingType.forNumber(i) != null;
                }
        ...
        private ListingType(String s, int i, int j)
        {
            super(s, i);
            value = j;
        }
    ...
    public static final RoomViewInfo DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public boolean containsListing_;
    public boolean containsSuggestions_;
    public int listingType_;

    private RoomViewInfo()
    {
    }

    public static RoomViewInfo parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new RoomViewInfo();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        obj = ListingType.internalVerifier;
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\007\000\002\007\001\003\f\002", new Object[] {
            "bitField0_", "containsSuggestions_", "containsListing_", "listingType_", obj
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/RoomViewInfo;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RoomViewInfo();
        RoomViewInfo roomviewinfo = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/RoomViewInfo, roomviewinfo);
    }
}
