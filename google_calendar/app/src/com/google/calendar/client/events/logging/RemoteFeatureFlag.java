...
public final class RemoteFeatureFlag extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(RemoteFeatureFlag.DEFAULT_INSTANCE);
        }
    }

    public static final class LocalOverride extends Enum
        implements com.google.protobuf.Internal.EnumLite
    {

        private static final LocalOverride $VALUES[];
        public static final LocalOverride DISABLE;
        public static final LocalOverride ENABLE;
        private static final LocalOverride UNSET;
        public static final com.google.protobuf.Internal.EnumVerifier internalVerifier = new _cls2();
        public final int value;

        public static LocalOverride forNumber(int i)
        {
            switch (i)
            {
            default:
        ...
        public static LocalOverride[] values()
        {
            return (LocalOverride[])$VALUES.clone();
        }
        ...
        static 
        {
            UNSET = new LocalOverride("UNSET", 0, 0);
            ENABLE = new LocalOverride("ENABLE", 1, 1);
            DISABLE = new LocalOverride("DISABLE", 2, 2);
            $VALUES = (new LocalOverride[] {
                ...
                implements com.google.protobuf.Internal.EnumVerifier
            {
                ...
                {
                    return LocalOverride.forNumber(i) != null;
                }
        ...
        private LocalOverride(String s, int i, int j)
        {
            super(s, i);
            value = j;
        }
    ...
    public static final RemoteFeatureFlag DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int adbFlagOverride_;
    public int bitField0_;
    public int experimentalDashboardOverride_;
    public boolean remoteValue_;
    public boolean value_;

    private RemoteFeatureFlag()
    {
    }

    public static RemoteFeatureFlag parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new RemoteFeatureFlag();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        obj = LocalOverride.internalVerifier;
        com.google.protobuf.Internal.EnumVerifier enumverifier = LocalOverride.internalVerifier;
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\004\000\001\001\004\004\000\000\000\001\007\000\002\007\001\003\f\002\004\f\003", new Object[] {
            "bitField0_", "value_", "remoteValue_", "experimentalDashboardOverride_", obj, "adbFlagOverride_", enumverifier
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/RemoteFeatureFlag;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new RemoteFeatureFlag();
        RemoteFeatureFlag remotefeatureflag = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/RemoteFeatureFlag, remotefeatureflag);
    }
}
