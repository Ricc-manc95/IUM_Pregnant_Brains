...
public final class PendingCalendarEvent extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(PendingCalendarEvent.DEFAULT_INSTANCE);
        }
    }


    public static final PendingCalendarEvent DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public String calendarId_;
    public String eventReference_;

    private PendingCalendarEvent()
    {
        eventReference_ = "";
        calendarId_ = "";
    }

    public static PendingCalendarEvent parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (PendingCalendarEvent)obj;
    }
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\b\000\002\b\001", new Object[] {
            "bitField0_", "eventReference_", "calendarId_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/PendingCalendarEvent;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new PendingCalendarEvent();
        PendingCalendarEvent pendingcalendarevent = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/PendingCalendarEvent, pendingcalendarevent);
    }
}
