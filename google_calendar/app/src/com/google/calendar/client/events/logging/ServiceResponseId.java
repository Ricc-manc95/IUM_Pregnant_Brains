...
public final class ServiceResponseId extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(ServiceResponseId.DEFAULT_INSTANCE);
        }
    }


    public static final ServiceResponseId DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public String suggestMeetingResponseId_;
    public String suggestRoomResponseId_;
    public String suggestTimeResponseId_;

    private ServiceResponseId()
    {
        suggestTimeResponseId_ = "";
        suggestRoomResponseId_ = "";
        suggestMeetingResponseId_ = "";
    }

    public static ServiceResponseId parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\b\000\002\b\001\003\b\002", new Object[] {
            "bitField0_", "suggestTimeResponseId_", "suggestRoomResponseId_", "suggestMeetingResponseId_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/ServiceResponseId;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new ServiceResponseId();
        ServiceResponseId serviceresponseid = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/ServiceResponseId, serviceresponseid);
    }
}
