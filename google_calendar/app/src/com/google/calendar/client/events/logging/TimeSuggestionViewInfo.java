...
public final class TimeSuggestionViewInfo extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TimeSuggestionViewInfo.DEFAULT_INSTANCE);
        }
    }


    public static final TimeSuggestionViewInfo DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public int numBestSuggestions_;
    public boolean suggestionsForRecurringEvent_;

    private TimeSuggestionViewInfo()
    {
    }

    public static TimeSuggestionViewInfo parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (TimeSuggestionViewInfo)obj;
    }
...
_L5:
        obj = new TimeSuggestionViewInfo();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\004\000\002\007\001", new Object[] {
            "bitField0_", "numBestSuggestions_", "suggestionsForRecurringEvent_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/TimeSuggestionViewInfo;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TimeSuggestionViewInfo();
        TimeSuggestionViewInfo timesuggestionviewinfo = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/TimeSuggestionViewInfo, timesuggestionviewinfo);
    }
}
