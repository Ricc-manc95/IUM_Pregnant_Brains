...
public final class CalendarClientVisualElementEntry extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(CalendarClientVisualElementEntry.DEFAULT_INSTANCE);
        }
    }


    public static final CalendarClientVisualElementEntry DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.common.logging.AncestryVisualElement.AncestryVisualElementProto ancestryVisualElement_;
    public int bitField0_;
    public CalendarClientVisualElementMetadata visualElementMetadata_;

    private CalendarClientVisualElementEntry()
    {
    }

    public static CalendarClientVisualElementEntry parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (CalendarClientVisualElementEntry)obj;
    }
...
_L5:
        obj = new CalendarClientVisualElementEntry();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\t\000\002\t\001", new Object[] {
            "bitField0_", "ancestryVisualElement_", "visualElementMetadata_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/CalendarClientVisualElementEntry;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new CalendarClientVisualElementEntry();
        CalendarClientVisualElementEntry calendarclientvisualelemententry = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/CalendarClientVisualElementEntry, calendarclientvisualelemententry);
    }
}
