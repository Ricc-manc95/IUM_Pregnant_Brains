...
//            CalendarClientLogEvent, CalendarClientVisualElementEntry

public final class CalendarClientEventsExtension extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(CalendarClientEventsExtension.DEFAULT_INSTANCE);
        }
    }


    public static final CalendarClientEventsExtension DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public com.google.protobuf.Internal.ProtobufList events_;
    public CalendarClientVisualElementEntry visualElementEntry_;

    private CalendarClientEventsExtension()
    {
        events_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static CalendarClientEventsExtension parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (CalendarClientEventsExtension)obj;
    }
...
_L5:
        obj = new CalendarClientEventsExtension();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\004\002\000\001\000\001\033\004\t\002", new Object[] {
            "bitField0_", "events_", com/google/calendar/client/events/logging/CalendarClientLogEvent, "visualElementEntry_"
        });
_L7:
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new CalendarClientEventsExtension();
        CalendarClientEventsExtension calendarclienteventsextension = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/CalendarClientEventsExtension, calendarclienteventsextension);
    }
}
