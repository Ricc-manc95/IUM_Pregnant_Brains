...
public final class AndroidSharedPref extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(AndroidSharedPref.DEFAULT_INSTANCE);
        }
    }


    public static final AndroidSharedPref DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public boolean value_;

    private AndroidSharedPref()
    {
    }

    public static AndroidSharedPref parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new AndroidSharedPref();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\001\001\001\001\000\000\000\001\007\0", new Object[] {
            "bitField0_", "value_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/AndroidSharedPref;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new AndroidSharedPref();
        AndroidSharedPref androidsharedpref = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/AndroidSharedPref, androidsharedpref);
    }
}
