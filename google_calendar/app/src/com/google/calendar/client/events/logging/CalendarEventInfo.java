...
public final class CalendarEventInfo extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(CalendarEventInfo.DEFAULT_INSTANCE);
        }
    }


    public static final CalendarEventInfo DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public String calendarEventId_;
    public String calendarEventReference_;

    private CalendarEventInfo()
    {
        calendarEventId_ = "";
        calendarEventReference_ = "";
    }

    public static CalendarEventInfo parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\b\000\002\b\001", new Object[] {
            "bitField0_", "calendarEventId_", "calendarEventReference_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/CalendarEventInfo;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new CalendarEventInfo();
        CalendarEventInfo calendareventinfo = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/CalendarEventInfo, calendareventinfo);
    }
}
