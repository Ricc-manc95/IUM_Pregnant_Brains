...
//            ConferencePhoneNumberLocationSource

public final class ConferenceMetadata extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(ConferenceMetadata.DEFAULT_INSTANCE);
        }
    }


    public static final ConferenceMetadata DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public int phoneNumberLocationSource_;

    private ConferenceMetadata()
    {
    }

    public static ConferenceMetadata parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new ConferenceMetadata();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        obj = ConferencePhoneNumberLocationSource.internalVerifier;
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\001\001\001\001\000\000\000\001\f\0", new Object[] {
            "bitField0_", "phoneNumberLocationSource_", obj
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/ConferenceMetadata;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new ConferenceMetadata();
        ConferenceMetadata conferencemetadata = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/ConferenceMetadata, conferencemetadata);
    }
}
