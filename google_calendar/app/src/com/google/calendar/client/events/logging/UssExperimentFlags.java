...
public final class UssExperimentFlags extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(UssExperimentFlags.DEFAULT_INSTANCE);
        }
    }


    public static final UssExperimentFlags DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public RemoteFeatureFlag enableSideSync_;
    public RemoteFeatureFlag enabled_;
    public RemoteFeatureFlag supportsCalendars_;
    public RemoteFeatureFlag supportsEvents_;
    public RemoteFeatureFlag supportsHabits_;
    public RemoteFeatureFlag supportsSettings_;
    public RemoteFeatureFlag syncCalendars_;

    private UssExperimentFlags()
    {
    }

    public static UssExperimentFlags parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new UssExperimentFlags();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\007\000\001\001\007\007\000\000\000\001\t\000\002\t\001\003\t\002\004\t\003\005\t\004\006\t\005\007\t\006", new Object[] {
            "bitField0_", "enabled_", "supportsSettings_", "supportsHabits_", "syncCalendars_", "supportsCalendars_", "supportsEvents_", "enableSideSync_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/UssExperimentFlags;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new UssExperimentFlags();
        UssExperimentFlags ussexperimentflags = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/UssExperimentFlags, ussexperimentflags);
    }
}
