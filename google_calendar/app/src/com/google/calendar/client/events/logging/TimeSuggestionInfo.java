...
public final class TimeSuggestionInfo extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TimeSuggestionInfo.DEFAULT_INSTANCE);
        }
    }


    public static final TimeSuggestionInfo DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public int rank_;
    public String suggestionToken_;

    private TimeSuggestionInfo()
    {
        suggestionToken_ = "";
    }

    public static TimeSuggestionInfo parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new TimeSuggestionInfo();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\002\002\000\000\000\001\b\000\002\004\001", new Object[] {
            "bitField0_", "suggestionToken_", "rank_"
        });
_L7:
...
_L9:
        com/google/calendar/client/events/logging/TimeSuggestionInfo;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TimeSuggestionInfo();
        TimeSuggestionInfo timesuggestioninfo = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/calendar/client/events/logging/TimeSuggestionInfo, timesuggestioninfo);
    }
}
