...
{
    public static final class IncrementRequest extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final IncrementRequest DEFAULT_INSTANCE;
        private static volatile Parser PARSER;
        public com.google.protobuf.Internal.ProtobufList batch_;

        public static IncrementRequest parseFrom(InputStream inputstream)
            throws IOException
        {
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new IncrementRequest();
            IncrementRequest incrementrequest = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(com/google/clearcut/streamz/StreamzProto$IncrementRequest, incrementrequest);
        }
    ...
    public static final class IncrementRequest.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        IncrementRequest.Builder()
        {
