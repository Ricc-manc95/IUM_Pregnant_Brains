...
// Referenced classes of package com.google.clearcut.streamz:
//            StreamzProto

public static final class batch_ extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public com.google.protobuf.Request batch_;
        ...
        throws IOException
    {
        ...
        {
            inputstream = new com.google.protobuf.(inputstream, 4096);
        }
        ...
        if (obj != null)
        {
            ...
            } else
            {
                ...
                if (flag1)
                {
                    int i = android.support.v4.content.OIZED_IS_INITIALIZED._fld9HHMUR9FCTNMUPRCCKNN0SJFEHNM4TB65T3MARJ5E9GN8PB49LIN6SR1CTIKOQBKCKI4QPBKD1NM8L3F95N7CRRBCKTG____0;
                    if (flag)
                    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\000\001\001\001\000\001\000\001\033", new Object[] {
            "batch_", com/google/frameworks/client/streamz/StreamzObjectsProto$IncrementBatch
        });
_L7:
...
_L11:
        obj = new com.google.protobuf.stanceBasedParser(DEFAULT_INSTANCE);
        PARSER = ((Parser) (obj));
_L12:
        com/google/clearcut/streamz/StreamzProto$IncrementRequest;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/clearcut/streamz/StreamzProto$IncrementRequest, parser);
    }

    private DEFAULT_INSTANCE()
    {
        batch_ = ProtobufArrayList.EMPTY_LIST;
    }
}
