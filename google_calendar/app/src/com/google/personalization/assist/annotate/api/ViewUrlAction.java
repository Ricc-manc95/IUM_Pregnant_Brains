...
public final class ViewUrlAction extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(ViewUrlAction.DEFAULT_INSTANCE);
        }
    }


    public static final ViewUrlAction DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public String actionDescription_;
    public String actionText_;
    public int bitField0_;
    public String title_;
    public String url_;

    private ViewUrlAction()
    {
        title_ = "";
        url_ = "";
        actionText_ = "";
    ...
    public static ViewUrlAction parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new ViewUrlAction();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\004\000\001\001\013\004\000\000\000\001\b\000\002\b\001\n\b\b\013\b\t", new Object[] {
            "bitField0_", "title_", "url_", "actionText_", "actionDescription_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/ViewUrlAction;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new ViewUrlAction();
        ViewUrlAction viewurlaction = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/ViewUrlAction, viewurlaction);
    }
}
