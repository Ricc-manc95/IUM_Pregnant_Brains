...
public final class Annotation extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public com.google.protobuf.Internal.ProtobufList fragment_;

    private Annotation()
    {
        fragment_ = ProtobufArrayList.EMPTY_LIST;
    }
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\001\001\001\001\000\001\000\001\033", new Object[] {
            "bitField0_", "fragment_", com/google/personalization/assist/annotate/api/AnnotationFragment
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/Annotation;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/Annotation, annotation);
    }
}
