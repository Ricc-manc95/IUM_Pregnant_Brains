...
public final class Temperature extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final Temperature DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public int preferredUnit_;
    public String tempC_;
    public String tempF_;
...
_L6:
        return new Builder();
_L4:
        obj = TemperatureUnit.internalVerifier;
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\b\000\002\b\002\003\f\004", new Object[] {
            "bitField0_", "tempF_", "tempC_", "preferredUnit_", obj
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/Temperature;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new Temperature();
        Temperature temperature = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/Temperature, temperature);
    }
}
