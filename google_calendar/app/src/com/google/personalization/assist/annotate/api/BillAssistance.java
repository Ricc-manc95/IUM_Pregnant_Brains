...
public final class BillAssistance extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(BillAssistance.DEFAULT_INSTANCE);
        }
    }


    public static final BillAssistance DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public Time dueDate_;
    public String payText_;
    public String payUrl_;

    private BillAssistance()
    {
        payUrl_ = "";
        payText_ = "";
    }

    public static BillAssistance parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new BillAssistance();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\002\005\003\000\000\000\002\t\001\004\b\003\005\b\004", new Object[] {
            "bitField0_", "dueDate_", "payUrl_", "payText_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/BillAssistance;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new BillAssistance();
        BillAssistance billassistance = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/BillAssistance, billassistance);
    }
}
