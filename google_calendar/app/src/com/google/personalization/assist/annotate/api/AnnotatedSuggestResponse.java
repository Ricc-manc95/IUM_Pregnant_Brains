...
public final class AnnotatedSuggestResponse extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(AnnotatedSuggestResponse.DEFAULT_INSTANCE);
        }
    }


    public static final AnnotatedSuggestResponse DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList annotatedSuggestion_;
    public int bitField0_;
    private byte memoizedIsInitialized;

    private AnnotatedSuggestResponse()
    {
        memoizedIsInitialized = 2;
        annotatedSuggestion_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static AnnotatedSuggestResponse parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (AnnotatedSuggestResponse)obj;
    }
...
_L5:
        obj = new AnnotatedSuggestResponse();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\001\002\002\001\000\001\001\002\u041B", new Object[] {
            "bitField0_", "annotatedSuggestion_", com/google/personalization/assist/annotate/api/AnnotatedSuggestion
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/AnnotatedSuggestResponse;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new AnnotatedSuggestResponse();
        AnnotatedSuggestResponse annotatedsuggestresponse = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/AnnotatedSuggestResponse, annotatedsuggestresponse);
    }
}
