...
public final class FinanceAssistance extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(FinanceAssistance.DEFAULT_INSTANCE);
        }
    }


    public static final FinanceAssistance DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public String actionText_;
    public int bitField0_;
    public double changeDbl_;
    public String financeUrl_;

    private FinanceAssistance()
    {
        financeUrl_ = "";
        actionText_ = "";
    }

    public static FinanceAssistance parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new FinanceAssistance();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\f\016\003\000\000\000\f\000\006\r\b\f\016\b\r", new Object[] {
            "bitField0_", "changeDbl_", "financeUrl_", "actionText_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/FinanceAssistance;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new FinanceAssistance();
        FinanceAssistance financeassistance = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/FinanceAssistance, financeassistance);
    }
}
