...
public final class WatchYoutubeAction extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(WatchYoutubeAction.DEFAULT_INSTANCE);
        }
    }


    public static final WatchYoutubeAction DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public String thumbnailUrl_;
    public String videoUrl_;

    private WatchYoutubeAction()
    {
        thumbnailUrl_ = "";
        videoUrl_ = "";
    }

    public static WatchYoutubeAction parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new WatchYoutubeAction();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\003\006\002\000\000\000\003\b\002\006\b\005", new Object[] {
            "bitField0_", "thumbnailUrl_", "videoUrl_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/WatchYoutubeAction;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new WatchYoutubeAction();
        WatchYoutubeAction watchyoutubeaction = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/WatchYoutubeAction, watchyoutubeaction);
    }
}
