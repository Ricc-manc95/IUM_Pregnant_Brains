...
public final class TimeComponent extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TimeComponent.DEFAULT_INSTANCE);
        }
    }


    public static final TimeComponent DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList interval_;

    private TimeComponent()
    {
        interval_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static TimeComponent parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\000\001\001\001\000\001\000\001\033", new Object[] {
            "interval_", com/google/personalization/assist/annotate/api/TimeInterval
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/TimeComponent;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TimeComponent();
        TimeComponent timecomponent = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/TimeComponent, timecomponent);
    }
}
