...
public final class AssistanceRequestData extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(AssistanceRequestData.DEFAULT_INSTANCE);
        }
    }


    public static final AssistanceRequestData DEFAULT_INSTANCE;
    ...
    public static AssistanceRequestData parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (AssistanceRequestData)obj;
    }
...
_L5:
        obj = new AssistanceRequestData();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\004\000\001\001\005\004\000\000\000\001\b\000\002\b\001\004\b\004\005\b\005", new Object[] {
            "bitField0_", "query_", "annotationHint_", "language_", "country_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/AssistanceRequestData;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new AssistanceRequestData();
        AssistanceRequestData assistancerequestdata = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/AssistanceRequestData, assistancerequestdata);
    }
}
