...
public final class AssistClick extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(AssistClick.DEFAULT_INSTANCE);
        }
    }


    public static final AssistClick DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int assistType_;
    public int bitField0_;
    public int grammarRuleType_;
    public String taskString_;
    ...
    public static AssistClick parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L6:
        return new Builder();
_L4:
        obj = AssistType.internalVerifier;
        com.google.protobuf.Internal.EnumVerifier enumverifier = GrammarRuleType.internalVerifier;
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\b\000\002\f\001\003\f\002", new Object[] {
            "bitField0_", "taskString_", "assistType_", obj, "grammarRuleType_", enumverifier
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/AssistClick;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new AssistClick();
        AssistClick assistclick = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/AssistClick, assistclick);
    }
}
