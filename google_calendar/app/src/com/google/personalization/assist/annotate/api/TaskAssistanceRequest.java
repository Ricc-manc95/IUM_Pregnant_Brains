...
public final class TaskAssistanceRequest extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TaskAssistanceRequest.DEFAULT_INSTANCE);
        }
    }


    public static final TaskAssistanceRequest DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public int clientType_;
    private byte memoizedIsInitialized;
    public com.google.protobuf.Internal.ProtobufList requestData_;
    public CustomizedSnoozePreset snoozePresets_;

    private TaskAssistanceRequest()
    {
        memoizedIsInitialized = 2;
        requestData_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static TaskAssistanceRequest parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (TaskAssistanceRequest)obj;
    }
...
_L4:
        ...
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\004\003\000\001\001\001\033\002\f\000\004\u0409\002", new Object[] {
            "bitField0_", "requestData_", com/google/personalization/assist/annotate/api/AssistanceRequestData, "clientType_", obj, "snoozePresets_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/TaskAssistanceRequest;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TaskAssistanceRequest();
        TaskAssistanceRequest taskassistancerequest = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/TaskAssistanceRequest, taskassistancerequest);
    }
}
