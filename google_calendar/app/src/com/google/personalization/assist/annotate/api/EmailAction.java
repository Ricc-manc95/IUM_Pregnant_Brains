...
public final class EmailAction extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final EmailAction DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public com.google.protobuf.Internal.ProtobufList emailAddress_;

    private EmailAction()
    {
        emailAddress_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static EmailAction parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\001\002\002\001\000\001\000\002\033", new Object[] {
            "bitField0_", "emailAddress_", com/google/personalization/assist/annotate/api/EmailAddress
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/EmailAction;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new EmailAction();
        EmailAction emailaction = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/EmailAction, emailaction);
    }
}
