...
public final class DeadlineAssistance extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(DeadlineAssistance.DEFAULT_INSTANCE);
        }
    }


    public static final DeadlineAssistance DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public EventTime eventTime_;

    private DeadlineAssistance()
    {
    }

    public static DeadlineAssistance parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new DeadlineAssistance();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\001\004\004\001\000\000\000\004\t\001", new Object[] {
            "bitField0_", "eventTime_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/DeadlineAssistance;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new DeadlineAssistance();
        DeadlineAssistance deadlineassistance = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/DeadlineAssistance, deadlineassistance);
    }
}
