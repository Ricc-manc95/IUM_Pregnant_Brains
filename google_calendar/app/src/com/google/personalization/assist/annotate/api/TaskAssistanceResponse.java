...
public final class TaskAssistanceResponse extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TaskAssistanceResponse.DEFAULT_INSTANCE);
        }
    }


    public static final TaskAssistanceResponse DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public com.google.protobuf.Internal.ProtobufList taskAssistance_;

    private TaskAssistanceResponse()
    {
        taskAssistance_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static TaskAssistanceResponse parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (TaskAssistanceResponse)obj;
    }
...
_L5:
        obj = new TaskAssistanceResponse();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\001\000\000\001\001\001\000\001\000\001\033", new Object[] {
            "taskAssistance_", com/google/personalization/assist/annotate/api/TaskAssistance
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/TaskAssistanceResponse;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TaskAssistanceResponse();
        TaskAssistanceResponse taskassistanceresponse = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/TaskAssistanceResponse, taskassistanceresponse);
    }
}
