...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\002\000\002\004\001\003\007\002", new Object[] {
            "bitField0_", "timeMs_", "timeZoneOffsetMinutes_", "dateOnly_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/Time;
...
_L3:
    ...
    static 
    {
        ...
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/Time, time);
    }
}
