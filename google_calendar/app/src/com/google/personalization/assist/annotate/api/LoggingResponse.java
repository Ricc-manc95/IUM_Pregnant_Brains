...
public final class LoggingResponse extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(LoggingResponse.DEFAULT_INSTANCE);
        }
    }


    public static final LoggingResponse DEFAULT_INSTANCE;
    ...
    public static LoggingResponse parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L9:
        com/google/personalization/assist/annotate/api/LoggingResponse;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new LoggingResponse();
        LoggingResponse loggingresponse = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/LoggingResponse, loggingresponse);
    }
}
