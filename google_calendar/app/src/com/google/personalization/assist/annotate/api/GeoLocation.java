...
public final class GeoLocation extends GeneratedMessageLite
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\004\000\002\004\001\003\004\002", new Object[] {
            "bitField0_", "latitudeE7_", "longitudeE7_", "accuracyRadius_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/GeoLocation;
...
_L3:
    ...
    static 
    {
        ...
        GeoLocation geolocation = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/GeoLocation, geolocation);
    }
}
