...
//            TimeSchedule, PhoneNumber

public final class OrganizationAssistance extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(OrganizationAssistance.DEFAULT_INSTANCE);
        }
    }


    public static final OrganizationAssistance DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public TimeSchedule operatingHours_;
    public PhoneNumber phoneNumber_;

    private OrganizationAssistance()
    {
    }

    public static OrganizationAssistance parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (OrganizationAssistance)obj;
    }
...
_L5:
        obj = new OrganizationAssistance();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\003\004\002\000\000\000\003\t\002\004\t\004", new Object[] {
            "bitField0_", "phoneNumber_", "operatingHours_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/OrganizationAssistance;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new OrganizationAssistance();
        OrganizationAssistance organizationassistance = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/OrganizationAssistance, organizationassistance);
    }
}
