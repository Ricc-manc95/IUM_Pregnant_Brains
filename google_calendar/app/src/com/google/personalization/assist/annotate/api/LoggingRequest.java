...
public final class LoggingRequest extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(LoggingRequest.DEFAULT_INSTANCE);
        }
    }


    public static final LoggingRequest DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public AssistClick assistClick_;
...
_L4:
        ...
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\005\000\001\005\r\005\000\000\000\005\f\000\006\f\001\t\b\002\n\b\003\r\t\006", new Object[] {
            "bitField0_", "clientType_", obj, "deviceType_", enumverifier, "language_", "country_", "assistClick_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/LoggingRequest;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new LoggingRequest();
        LoggingRequest loggingrequest = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/LoggingRequest, loggingrequest);
    }
}
