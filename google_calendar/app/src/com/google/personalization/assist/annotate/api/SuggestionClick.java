...
public final class SuggestionClick extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(SuggestionClick.DEFAULT_INSTANCE);
        }
    }


    public static final SuggestionClick DEFAULT_INSTANCE;
    private static volatile Parser PARSER;

    private SuggestionClick()
    {
    }

    public static SuggestionClick parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L9:
        com/google/personalization/assist/annotate/api/SuggestionClick;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new SuggestionClick();
        SuggestionClick suggestionclick = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/SuggestionClick, suggestionclick);
    }
}
