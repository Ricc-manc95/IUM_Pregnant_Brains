...
public final class ReturnProductAssistance extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(ReturnProductAssistance.DEFAULT_INSTANCE);
        }
    }


    public static final ReturnProductAssistance DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public boolean alwaysReturnable_;
    public int bitField0_;
    public Time returnDeadline_;

    private ReturnProductAssistance()
    {
    }

    public static ReturnProductAssistance parseFrom(InputStream inputstream)
        throws IOException
    {
        ...
        return (ReturnProductAssistance)obj;
    }
...
_L5:
        obj = new ReturnProductAssistance();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\005\006\002\000\000\000\005\007\004\006\t\005", new Object[] {
            "bitField0_", "alwaysReturnable_", "returnDeadline_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/ReturnProductAssistance;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new ReturnProductAssistance();
        ReturnProductAssistance returnproductassistance = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/ReturnProductAssistance, returnproductassistance);
    }
}
