...
public final class TimeSchedule extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TimeSchedule.DEFAULT_INSTANCE);
        }
    }


    public static final TimeSchedule DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public com.google.protobuf.Internal.ProtobufList component_;
    public int timeZoneOffsetMinutes_;

    private TimeSchedule()
    {
        component_ = ProtobufArrayList.EMPTY_LIST;
    }

    public static TimeSchedule parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new TimeSchedule();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\002\000\001\001\003\002\000\001\000\001\033\003\004\001", new Object[] {
            "bitField0_", "component_", com/google/personalization/assist/annotate/api/TimeComponent, "timeZoneOffsetMinutes_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/TimeSchedule;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TimeSchedule();
        TimeSchedule timeschedule = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/TimeSchedule, timeschedule);
    }
}
