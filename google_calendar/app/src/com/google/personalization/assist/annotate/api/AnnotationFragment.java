...
//            Contact, EventTime, Place

public final class AnnotationFragment extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(AnnotationFragment.DEFAULT_INSTANCE);
        }
    }


    public static final AnnotationFragment DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int annotationType_;
    public int beginPos_;
    public int bitField0_;
    public Contact contact_;
    public int endPos_;
    public EventTime eventTime_;
    public Place localBusiness_;
    public String text_;
    ...
    public static AnnotationFragment parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new AnnotationFragment();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        obj = AnnotationType.internalVerifier;
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\007\000\001\001\007\007\000\000\000\001\b\000\002\f\001\003\004\002\004\004\003\005\t\b\006\t\013\007\t\n", new Object[] {
            "bitField0_", "text_", "annotationType_", obj, "beginPos_", "endPos_", "contact_", "localBusiness_", "eventTime_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/AnnotationFragment;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new AnnotationFragment();
        AnnotationFragment annotationfragment = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/AnnotationFragment, annotationfragment);
    }
}
