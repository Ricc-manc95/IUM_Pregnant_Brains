...
public final class EventTime extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final EventTime DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public boolean allDay_;
    public int bitField0_;
    public Time endTime_;
    ...
    public static EventTime parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\t\000\002\t\001\003\007\002", new Object[] {
            "bitField0_", "startTime_", "endTime_", "allDay_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/EventTime;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new EventTime();
        EventTime eventtime = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/EventTime, eventtime);
    }
}
