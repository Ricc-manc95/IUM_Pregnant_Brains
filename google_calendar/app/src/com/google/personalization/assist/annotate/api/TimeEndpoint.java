...
public final class TimeEndpoint extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
        ...
        implements MessageLiteOrBuilder
    {
        ...
        Builder()
        {
            super(TimeEndpoint.DEFAULT_INSTANCE);
        }
    }


    public static final TimeEndpoint DEFAULT_INSTANCE;
    ...
    public static TimeEndpoint parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L4:
        ...
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\003\000\001\001\003\003\000\000\000\001\004\000\002\004\001\003\f\002", new Object[] {
            "bitField0_", "minute_", "hour_", "day_", obj
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/TimeEndpoint;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new TimeEndpoint();
        TimeEndpoint timeendpoint = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/TimeEndpoint, timeendpoint);
    }
}
