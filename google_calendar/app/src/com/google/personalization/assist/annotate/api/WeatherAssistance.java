...
public final class WeatherAssistance extends GeneratedMessageLite
    implements MessageLiteOrBuilder
{
    ...
    public static final WeatherAssistance DEFAULT_INSTANCE;
    private static volatile Parser PARSER;
    public int bitField0_;
    public String currentConditionDesc_;
    public Temperature currentTemp_;
    public String forecastText_;
    public String forecastUrl_;
    public String location_;

    private WeatherAssistance()
    {
        location_ = "";
        currentConditionDesc_ = "";
        forecastUrl_ = "";
        forecastText_ = "";
    }

    public static WeatherAssistance parseFrom(InputStream inputstream)
        throws IOException
    {
...
_L5:
        obj = new WeatherAssistance();
_L10:
        return obj;
_L6:
        return new Builder();
_L4:
        return new RawMessageInfo(DEFAULT_INSTANCE, "\001\005\000\001\001\r\005\000\000\000\001\b\000\003\t\003\013\b\n\f\b\013\r\b\002", new Object[] {
            "bitField0_", "location_", "currentTemp_", "forecastUrl_", "forecastText_", "currentConditionDesc_"
        });
_L7:
...
_L9:
        com/google/personalization/assist/annotate/api/WeatherAssistance;
...
_L3:
    ...
    static 
    {
        DEFAULT_INSTANCE = new WeatherAssistance();
        WeatherAssistance weatherassistance = DEFAULT_INSTANCE;
        GeneratedMessageLite.defaultInstanceMap.put(com/google/personalization/assist/annotate/api/WeatherAssistance, weatherassistance);
    }
}
