...
{
    public static final class GcsExtension extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final GcsExtension DEFAULT_INSTANCE;
        private static volatile Parser PARSER;

        public static GcsExtension parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (GcsExtension)generatedmessagelite;
        }
...
_L9:
            logs/proto/wireless/performance/mobile/ExtensionGcs$GcsExtension;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new GcsExtension();
            GcsExtension gcsextension = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(logs/proto/wireless/performance/mobile/ExtensionGcs$GcsExtension, gcsextension);
        }
    ...
    public static final class GcsExtension.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        GcsExtension.Builder()
        {
