...
{
    public static final class IosProcessStats extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final IosProcessStats DEFAULT_INSTANCE;
        private static volatile Parser PARSER;

        public static IosProcessStats parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (IosProcessStats)generatedmessagelite;
        }
...
_L9:
            logs/proto/wireless/performance/mobile/ProcessProto$IosProcessStats;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new IosProcessStats();
            IosProcessStats iosprocessstats = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(logs/proto/wireless/performance/mobile/ProcessProto$IosProcessStats, iosprocessstats);
        }
    ...
    public static final class IosProcessStats.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        IosProcessStats.Builder()
        {
