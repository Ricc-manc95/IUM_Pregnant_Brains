...
public final class AggregatedMetric extends ExtendableMessageNano
{

    private static volatile AggregatedMetric _emptyArray[];
    ...
    protected final int computeSerializedSize()
    {
        ...
        if (identifier != null)
        {
            i = j + CodedOutputByteBufferNano.computeMessageSize(1, identifier);
        }
        j = i;
        if (aggregatedData != null)
        {
            j = i + CodedOutputByteBufferNano.computeMessageSize(2, aggregatedData);
        }
        return j;
    }
        ...
        throws IOException
    {
        do
        {
            ...
            case 18: // '\022'
                ...
                codedinputbytebuffernano.readMessage(aggregatedData);
                break;
            }
        } while (true);
    }
        ...
        throws IOException
    {
        ...
        if (aggregatedData != null)
        {
            codedoutputbytebuffernano.writeMessage(2, aggregatedData);
        }
        super.writeTo(codedoutputbytebuffernano);
    }

    private class Identifier extends ExtendableMessageNano
    {
        ...
        private final Identifier mergeFrom(CodedInputByteBufferNano codedinputbytebuffernano)
            throws IOException
        {
_L11:
            int i = codedinputbytebuffernano.readTag();
