...
{
    public static final class GmailExtension extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final GmailExtension DEFAULT_INSTANCE;
        private static volatile Parser PARSER;

        public static GmailExtension parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (GmailExtension)generatedmessagelite;
        }
...
_L9:
            logs/proto/wireless/performance/mobile/ExtensionGmail$GmailExtension;
...
_L3:
        ...
        static 
        {
                ...
                implements com.google.protobuf.Internal.ListAdapter.Converter
            {
                ...
                {
                    com.android.mail.perf.PrimesMetricExtensionEnums.Annotation annotation = com.android.mail.perf.PrimesMetricExtensionEnums.Annotation.forNumber(((Integer)obj).intValue());
                    obj = annotation;
                    if (annotation == null)
                    {
                        obj = com.android.mail.perf.PrimesMetricExtensionEnums.Annotation.UNKNOWN_ANNOTATION;
                    }
                    return obj;
                }
            ...
            new _cls1();
            DEFAULT_INSTANCE = new GmailExtension();
            GmailExtension gmailextension = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(logs/proto/wireless/performance/mobile/ExtensionGmail$GmailExtension, gmailextension);
        }
    ...
    public static final class GmailExtension.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        GmailExtension.Builder()
        {
