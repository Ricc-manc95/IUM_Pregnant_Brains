...
{
    public static final class IosMemoryStats extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final IosMemoryStats DEFAULT_INSTANCE;
        private static volatile Parser PARSER;

        public static IosMemoryStats parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (IosMemoryStats)generatedmessagelite;
        }
...
_L9:
            logs/proto/wireless/performance/mobile/MemoryMetric$IosMemoryStats;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new IosMemoryStats();
            IosMemoryStats iosmemorystats = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(logs/proto/wireless/performance/mobile/MemoryMetric$IosMemoryStats, iosmemorystats);
        }
    ...
    public static final class IosMemoryStats.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        IosMemoryStats.Builder()
        {
