...
{
    public static final class AppInstallMetric extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final AppInstallMetric DEFAULT_INSTANCE;
        private static volatile Parser PARSER;

        public static AppInstallMetric parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (AppInstallMetric)generatedmessagelite;
        }
...
_L9:
            logs/proto/wireless/performance/mobile/ExtensionCloudDpc$AppInstallMetric;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new AppInstallMetric();
            AppInstallMetric appinstallmetric = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(logs/proto/wireless/performance/mobile/ExtensionCloudDpc$AppInstallMetric, appinstallmetric);
        }
    ...
    public static final class AppInstallMetric.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        AppInstallMetric.Builder()
        {
            super(AppInstallMetric.DEFAULT_INSTANCE);
        }
    }

    public static final class TaskFailMetric extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final TaskFailMetric DEFAULT_INSTANCE;
        private static volatile Parser PARSER;

        public static TaskFailMetric parseFrom(InputStream inputstream)
            throws IOException
        {
            GeneratedMessageLite generatedmessagelite = GeneratedMessageLite.parsePartialFrom(DEFAULT_INSTANCE, CodedInputStream.newInstance(inputstream), ExtensionRegistryLite.getEmptyRegistry());
            if (generatedmessagelite != null)
            ...
            return (TaskFailMetric)generatedmessagelite;
        }
...
_L8:
            ...
            if (parser != null) goto _L10; else goto _L9
_L9:
            logs/proto/wireless/performance/mobile/ExtensionCloudDpc$TaskFailMetric;
            JVM INSTR monitorenter ;
            parser = PARSER;
            obj = parser;
            if (parser != null) goto _L12; else goto _L11
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new TaskFailMetric();
            TaskFailMetric taskfailmetric = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(logs/proto/wireless/performance/mobile/ExtensionCloudDpc$TaskFailMetric, taskfailmetric);
        }
    ...
    public static final class TaskFailMetric.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        TaskFailMetric.Builder()
        {
