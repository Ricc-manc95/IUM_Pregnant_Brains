...
{
    public static final class PidHealthProto extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final PidHealthProto DEFAULT_INSTANCE;
        private static volatile Parser PARSER;

        public static PidHealthProto parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (PidHealthProto)generatedmessagelite;
        }
...
_L9:
            logs/proto/wireless/performance/mobile/BatteryMetric$PidHealthProto;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new PidHealthProto();
            PidHealthProto pidhealthproto = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(logs/proto/wireless/performance/mobile/BatteryMetric$PidHealthProto, pidhealthproto);
        }
    ...
    public static final class PidHealthProto.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        PidHealthProto.Builder()
        {
