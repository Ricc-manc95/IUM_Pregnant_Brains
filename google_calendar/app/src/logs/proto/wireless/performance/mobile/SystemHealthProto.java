...
{
    public static final class FrameRateMetric extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final FrameRateMetric DEFAULT_INSTANCE;
        private static volatile Parser PARSER;

        public static FrameRateMetric parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (FrameRateMetric)generatedmessagelite;
        }
...
_L9:
            logs/proto/wireless/performance/mobile/SystemHealthProto$FrameRateMetric;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new FrameRateMetric();
            FrameRateMetric frameratemetric = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(logs/proto/wireless/performance/mobile/SystemHealthProto$FrameRateMetric, frameratemetric);
        }
    ...
    public static final class FrameRateMetric.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        FrameRateMetric.Builder()
        {
