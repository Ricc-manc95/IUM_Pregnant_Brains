...
{
    public static final class TelemetryMetric extends GeneratedMessageLite
        implements MessageLiteOrBuilder
    {

        public static final TelemetryMetric DEFAULT_INSTANCE;
        private static volatile Parser PARSER;

        public static TelemetryMetric parseFrom(InputStream inputstream)
            throws IOException
        {
            ...
            return (TelemetryMetric)generatedmessagelite;
        }
...
_L9:
            logs/proto/wireless/performance/mobile/TelemetryProto$TelemetryMetric;
...
_L3:
        ...
        static 
        {
            DEFAULT_INSTANCE = new TelemetryMetric();
            TelemetryMetric telemetrymetric = DEFAULT_INSTANCE;
            GeneratedMessageLite.defaultInstanceMap.put(logs/proto/wireless/performance/mobile/TelemetryProto$TelemetryMetric, telemetrymetric);
        }
    ...
    public static final class TelemetryMetric.Builder extends com.google.protobuf.GeneratedMessageLite.Builder
        implements MessageLiteOrBuilder
    {

        TelemetryMetric.Builder()
        {
