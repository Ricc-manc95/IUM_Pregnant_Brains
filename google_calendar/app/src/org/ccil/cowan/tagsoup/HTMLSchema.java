...
public final class HTMLSchema extends Schema
{
    ...
    public HTMLSchema()
    {
        ...
        setPrefix("html");
        elementType("<pcdata>", 0, 0x40000000, 0);
        elementType("<root>", 0x80000000, 0, 0);
        elementType("a", 0x40008000, 4096, 0);
        elementType("abbr", 0x40001000, 36864, 1);
        elementType("acronym", 0x40001000, 36864, 1);
        elementType("address", 0x40041000, 4, 0);
        elementType("applet", 0x40081004, 36864, 0);
        elementType("area", 0, 2, 0);
        elementType("b", 0x40001000, 36864, 1);
        elementType("base", 0, 1024, 0);
        elementType("basefont", 0, 36864, 0);
        elementType("bdo", 0x40001000, 36864, 1);
        elementType("bgsound", 0, 1024, 0);
        elementType("big", 0x40001000, 36864, 1);
        elementType("blink", 0x40001000, 36864, 1);
        elementType("blockquote", 0x40001004, 4, 0);
        elementType("body", 0x40001004, 2064, 0);
        elementType("br", 0, 36864, 0);
        elementType("button", 0x40001004, 36864, 0);
        elementType("canvas", 0x40001000, 36864, 0);
        elementType("caption", 0x40001000, 0x200000, 0);
        elementType("center", 0x40001004, 4, 0);
        elementType("cite", 0x40001000, 36864, 1);
        elementType("code", 0x40001000, 36864, 1);
        elementType("col", 0, 0x200040, 0);
        elementType("colgroup", 64, 0x200000, 0);
        elementType("comment", 0x40001000, 36864, 0);
        elementType("dd", 0x40001004, 128, 0);
        elementType("del", 0x40001004, 4108, 1);
        elementType("dfn", 0x40001000, 36864, 1);
        elementType("dir", 16384, 4, 0);
        elementType("div", 0x40001004, 4, 0);
        elementType("dl", 128, 4, 0);
        elementType("dt", 0x40001000, 128, 0);
        elementType("em", 0x40001000, 36864, 1);
        elementType("fieldset", 0x40003004, 4, 0);
        elementType("font", 0x40001000, 36864, 0);
        elementType("form", 0x40409024, 260, 4);
        elementType("frame", 0, 512, 0);
        elementType("frameset", 512, 2560, 0);
        elementType("h1", 0x40001000, 4, 0);
        elementType("h2", 0x40001000, 4, 0);
        elementType("h3", 0x40001000, 4, 0);
        elementType("h4", 0x40001000, 4, 0);
        elementType("h5", 0x40001000, 4, 0);
        elementType("h6", 0x40001000, 4, 0);
        elementType("head", 1024, 2048, 0);
        elementType("hr", 0, 4, 0);
        elementType("html", 2048, 0x80000000, 0);
        elementType("i", 0x40001000, 36864, 1);
        elementType("iframe", 0x40001004, 36864, 0);
        elementType("img", 0, 36864, 0);
        elementType("input", 0, 36864, 0);
        elementType("ins", 0x40001004, 4100, 1);
        elementType("isindex", 0, 1024, 0);
        elementType("kbd", 0x40001000, 36864, 1);
        elementType("label", 0x40001000, 36864, 0);
        elementType("legend", 0x40001000, 8192, 0);
        elementType("li", 0x40001004, 16384, 0);
        elementType("link", 0, 5120, 0);
        elementType("listing", 0x40001000, 4, 0);
        elementType("map", 6, 4096, 0);
        elementType("marquee", 0x40001000, 36864, 0);
        elementType("menu", 16384, 4, 0);
        elementType("meta", 0, 1024, 0);
        elementType("nobr", 0x40001000, 36864, 0);
        elementType("noframes", 4116, 2564, 0);
        elementType("noscript", 0x40001004, 0x7fffffff, 0);
        elementType("object", 0x40081004, 37888, 0);
        elementType("ol", 16384, 4, 0);
        elementType("optgroup", 0x20000, 0x20000, 0);
        elementType("option", 0x40000000, 0x30000, 0);
        elementType("p", 0x40101000, 0x40004, 0);
        elementType("param", 0, 0x80000, 0);
        elementType("pre", 0x40001000, 4, 0);
        elementType("q", 0x40001000, 36864, 1);
        elementType("rb", 0x40001000, 36864, 1);
        elementType("rbc", 0x40001000, 36864, 1);
        elementType("rp", 0x40001000, 36864, 1);
        elementType("rt", 0x40001000, 36864, 1);
        elementType("rtc", 0x40001000, 36864, 1);
        elementType("ruby", 0x40001000, 36864, 1);
        elementType("s", 0x40001000, 36864, 1);
        elementType("samp", 0x40001000, 36864, 1);
        elementType("script", 0x40000000, 0x7fffffff, 2);
        elementType("select", 0x20000, 4096, 0);
        elementType("small", 0x40001000, 36864, 1);
        elementType("span", 0x40001000, 36864, 0);
        elementType("strike", 0x40001000, 36864, 1);
        elementType("strong", 0x40001000, 36864, 1);
        elementType("style", 0x40000000, 5120, 2);
        elementType("sub", 0x40001000, 36864, 1);
        elementType("sup", 0x40001000, 36864, 1);
        elementType("table", 0x200100, 0x100004, 4);
        elementType("tbody", 0x400000, 0x200000, 0);
        elementType("td", 0x40001004, 32, 0);
        elementType("textarea", 0x40000000, 4096, 0);
        elementType("tfoot", 0x400120, 0x200000, 0);
        elementType("th", 0x40001004, 32, 0);
        elementType("thead", 0x400120, 0x200000, 0);
        elementType("title", 0x40000000, 1024, 0);
        elementType("tr", 288, 0x600000, 0);
        elementType("tt", 0x40001000, 36864, 1);
        elementType("u", 0x40001000, 36864, 1);
        elementType("ul", 16384, 4, 0);
        elementType("var", 0x40001000, 36864, 0);
        elementType("wbr", 0, 36864, 0);
        elementType("xmp", 0x40001000, 4, 0);
        parent("<pcdata>", "body");
        parent("html", "<root>");
        parent("a", "body");
        parent("abbr", "body");
