...
public final class TransitionManager
{
    ...
    {
        Object obj = (WeakReference)sRunningTransitions.get();
        if (obj != null)
        {
            obj = (ArrayMap)((WeakReference) (obj)).get();
            if (obj != null)
            {
                return ((ArrayMap) (obj));
            }
    ...
    static void sceneChangeRunTransition(ViewGroup viewgroup, Transition transition)
    {
...
_L3:
            ...
            while (j >= 0) 
            {
                ...
                obj4 = (Transition.AnimationInfo)((SimpleArrayMap) (obj)).get(obj3);
                if (obj4 == null || ((Transition.AnimationInfo) (obj4)).mView == null || !obj2.equals(((Transition.AnimationInfo) (obj4)).mWindowId))
                {
                    continue;
                }
                obj5 = ((Transition.AnimationInfo) (obj4)).mValues;
                obj7 = ((Transition.AnimationInfo) (obj4)).mView;
                obj6 = ((Transition) (obj1)).getTransitionValues(((View) (obj7)), true);
                obj7 = ((Transition) (obj1)).getMatchedTransitionValues(((View) (obj7)), true);
                if ((obj6 != null || obj7 != null) && ((Transition.AnimationInfo) (obj4)).mTransition.isTransitionRequired(((TransitionValues) (obj5)), ((TransitionValues) (obj7))))
                {
                    flag = true;
                } else
                {
