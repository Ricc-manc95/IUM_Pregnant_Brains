    ...
    implements android.content.DialogInterface.OnClickListener, android.content.DialogInterface.OnDismissListener, android.content.DialogInterface.OnKeyListener, MenuPresenter.Callback
{
    ...
    {
        dialoginterface = mMenu;
        ListMenuPresenter listmenupresenter = mPresenter;
        if (listmenupresenter.mAdapter == null)
        {
            listmenupresenter.mAdapter = new ListMenuPresenter.MenuAdapter(listmenupresenter);
        }
        dialoginterface.performItemAction((MenuItemImpl)listmenupresenter.mAdapter.getItem(i), null, 0);
    }
